...
#include "CoreAudioSettings.generated.h"

USTRUCT()
struct GAMECORE_API FSubmixEffectChainMap
{
	GENERATED_BODY()
 ...
 * 
 * @note
 * 需在DefaultGame.ini中配置此类的属性
 */
UCLASS(Config=Game, Defaultconfig)
class GAMECORE_API UCoreAudioSettings : public UDeveloperSettings
{
	GENERATED_BODY()
...
public:
	...
	TArray<FSubmixEffectChainMap> HDRAudioSubmixEffectChain;
	
	/** Submix Processing Chains to achieve low dynamic range audio output */
	UPROPERTY(Config, EditAnywhere, Category="EffectSettings")
	TArray<FSubmixEffectChainMap> LDRAudioSubmixEffectChain;
};
