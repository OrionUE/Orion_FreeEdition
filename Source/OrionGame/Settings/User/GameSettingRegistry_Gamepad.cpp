...
UGameSettingCollection* UOrionGameSettingRegistry::InitializeGamepadSettings(UCoreLocalPlayer* InLocalPlayer)
{
	...
	////////////////////////////////////////////////////////////////////////////////////
	{
		...
		// Enum option for which input API to use
		{
			...
			Setting->SetDefaultValue(GetDefault<UOrionSettingsShared>()->GetGamepadInputAPIOption());
			...
			Setting->AddEnumOption(EOrionGamepadInputAPIOption::Legacy, LOCTEXT("GamepadAPI_Option_Legacy", "XInput + DualShock"));
			Setting->AddEnumOption(EOrionGamepadInputAPIOption::Modern, LOCTEXT("GamepadAPI_Option_Modern", "Game Input"));
