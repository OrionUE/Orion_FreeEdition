...
void UOrionGameSettingRegistry::AddDLCPage(UGameSettingCollection* Screen, UCoreLocalPlayer* InLocalPlayer)
{
	...
	PlatformDLC->RegisterInitializationCallback([
		WeakThis    = TWeakObjectPtr<UOrionGameSettingRegistry>(this),
		WeakDLCPage = TWeakObjectPtr<UGameSettingCollectionPage>(DLCPage),
		InitCondition,
		PlatformDLC
	]()
	{
		UOrionGameSettingRegistry* This = WeakThis.Get();
...
void UOrionGameSettingRegistry::AddDLCPage(UGameSettingCollection*, UCoreLocalPlayer*)
{
}
