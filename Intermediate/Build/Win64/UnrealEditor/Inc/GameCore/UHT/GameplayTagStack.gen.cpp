...
GAMECORE_API UScriptStruct* Z_Construct_UScriptStruct_FGameplayTagStack();
GAMECORE_API UScriptStruct* Z_Construct_UScriptStruct_FGameplayTagStackContainer();
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FGameplayTagStack;
class UScriptStruct* FGameplayTagStack::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FGameplayTagStack.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FGameplayTagStack.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGameplayTagStack, (UObject*)Z_Construct_UPackage__Script_GameCore(), TEXT("GameplayTagStack"));
	}
	return Z_Registration_Info_UScriptStruct_FGameplayTagStack.OuterSingleton;
}
...
#endif
		{ "ModuleRelativePath", "Public/System/GameplayTagStack.h" },
#if !UE_BUILD_SHIPPING
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FGameplayTagStack_Statics::NewProp_Tag = { "Tag", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FGameplayTagStack, Tag), Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Tag_MetaData), NewProp_Tag_MetaData) }; // 133831994
...
{
	if (!Z_Registration_Info_UScriptStruct_FGameplayTagStack.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FGameplayTagStack.InnerSingleton, Z_Construct_UScriptStruct_FGameplayTagStack_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FGameplayTagStack.InnerSingleton;
}
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FGameplayTagStackContainer;
class UScriptStruct* FGameplayTagStackContainer::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FGameplayTagStackContainer.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FGameplayTagStackContainer.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGameplayTagStackContainer, (UObject*)Z_Construct_UPackage__Script_GameCore(), TEXT("GameplayTagStackContainer"));
	}
	return Z_Registration_Info_UScriptStruct_FGameplayTagStackContainer.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FGameplayTagStackContainer.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FGameplayTagStackContainer.InnerSingleton, Z_Construct_UScriptStruct_FGameplayTagStackContainer_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FGameplayTagStackContainer.InnerSingleton;
}
// ********** End ScriptStruct FGameplayTagStackContainer ******************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Orion_FreeEdition_Source_GameCore_Public_System_GameplayTagStack_h__Script_GameCore_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FGameplayTagStack::StaticStruct, Z_Construct_UScriptStruct_FGameplayTagStack_Statics::NewStructOps, TEXT("GameplayTagStack"), &Z_Registration_Info_UScriptStruct_FGameplayTagStack, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGameplayTagStack), 2749710484U) },
		{ FGameplayTagStackContainer::StaticStruct, Z_Construct_UScriptStruct_FGameplayTagStackContainer_Statics::NewStructOps, TEXT("GameplayTagStackContainer"), &Z_Registration_Info_UScriptStruct_FGameplayTagStackContainer, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGameplayTagStackContainer), 3271796882U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Orion_FreeEdition_Source_GameCore_Public_System_GameplayTagStack_h__Script_GameCore_1292935058(TEXT("/Script/GameCore"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Orion_FreeEdition_Source_GameCore_Public_System_GameplayTagStack_h__Script_GameCore_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Orion_FreeEdition_Source_GameCore_Public_System_GameplayTagStack_h__Script_GameCore_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
