...
{
	int32 InValueInt = FMath::RoundHalfFromZero(InValue / SourceStep);
	InValue = InValueInt * SourceStep;
	...
	int32 OldValueInt = FMath::RoundHalfFromZero(GetValue() / SourceStep);
	double OldValue = OldValueInt * SourceStep;
	if (OldValue != InValue)
	{
