...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionAddItem : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Add Item", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|InventoryService|Async")
	static UOrionSteamWebAPIAsyncActionAddItem* AddItemAsync(UObject* WorldContextObject, FString Key, int32 AppId, TArray<int32> ItemdefId, FString ItemPropsJson, TArray<int32> ItemQuantity, FString SteamId, bool bNotify, FString RequestId, bool bTradeRestriction);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionAddPromoItem : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Add Promo Item", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|InventoryService|Async")
	static UOrionSteamWebAPIAsyncActionAddPromoItem* AddPromoItemAsync(UObject* WorldContextObject, FString Key, int32 AppId, int32 ItemdefId, FString ItemPropsJson, FString SteamId, bool bNotify, FString RequestId);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionConsumeItem : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 * @param	RequestId (int64)
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Consume Item", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|InventoryService|Async")
	static UOrionSteamWebAPIAsyncActionConsumeItem* ConsumeItemAsync(UObject* WorldContextObject, FString Key, int32 AppId, FString ItemID, FString Quantity, FString SteamId, FString RequestId);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionExchangeItem : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Exchange Item", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|InventoryService|Async")
	static UOrionSteamWebAPIAsyncActionExchangeItem* ExchangeItemAsync(UObject* WorldContextObject, FString Key, int32 AppId, FString SteamId, TArray<int64> MaterialsItemId, TArray<int32> MaterialsQuantity, int64 OutputItemdefId);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionGetInventory : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Get Inventory", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|InventoryService|Async")
	static UOrionSteamWebAPIAsyncActionGetInventory* GetInventoryAsync(UObject* WorldContextObject, FString Key, int32 AppId, FString SteamId);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionGetItemDefs : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Get Item Defs", AutoCreateRefTerm="ItemdefIDs, WorkshopIDs", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|InventoryService|Async")
	static UOrionSteamWebAPIAsyncActionGetItemDefs* GetItemDefsAsync(UObject* WorldContextObject, FString Key, int32 AppId, FString ModifiedSince, TArray<int32> ItemdefIDs, TArray<int32> WorkshopIDs, int32 CacheMaxAgeSeconds);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionGetPriceSheet : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 * @param	Key			Steamworks Web API publisher authentication Key.
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Get Price Sheet", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|InventoryService|Async")
	static UOrionSteamWebAPIAsyncActionGetPriceSheet* GetPriceSheetAsync(UObject* WorldContextObject, FString Key, int32 Currency);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionConsolidate : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 * @param	bForce
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Consolidate"), Category="OrionSteamWebAPI|InventoryService|Async")
	static UOrionSteamWebAPIAsyncActionConsolidate* ConsolidateAsync(UObject* WorldContextObject, FString Key, int32 AppId, FString SteamId, TArray<int32> ItemdefIDs, bool bForce);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionGetQuantity : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 * @param	bForce
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Get Quantity"), Category="OrionSteamWebAPI|InventoryService|Async")
	static UOrionSteamWebAPIAsyncActionGetQuantity* GetQuantityAsync(UObject* WorldContextObject, FString Key, int32 AppId, FString SteamId, TArray<int32> ItemdefIDs, bool bForce);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionModifyItems : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Modify Items"), Category="OrionSteamWebAPI|InventoryService|Async")
	static UOrionSteamWebAPIAsyncActionModifyItems* ModifyItemsAsync(UObject* WorldContextObject, FString Key, int32 AppId, FString SteamId, FModifyItemsItem Updates);
};
