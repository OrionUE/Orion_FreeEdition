...
UCLASS()
class ORIONSTEAMWEBAPI_API UWebInventoryService : public UOrionSteamWebAPISubsystem
{
	GENERATED_BODY()
public:
	UWebInventoryService()
	{
		SubsystemType = ESubsystemWeb::Inventory;
	}
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|InventoryService")
	void AddItem(const FOnOrionSteamWebAPICallback& Callback, FString Key, int32 AppId, TArray<int32> ItemdefId, FString ItemPropsJson, TArray<int32> ItemQuantity, FString SteamId, bool bNotify, FString RequestId, bool bTradeRestriction);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|InventoryService")
	void AddPromoItem(const FOnOrionSteamWebAPICallback& Callback, FString Key, int32 AppId, int32 ItemdefId, FString ItemPropsJson, FString SteamId, bool bNotify, FString RequestId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|InventoryService")
	void ConsumeItem(const FOnOrionSteamWebAPICallback& Callback, FString Key, int32 AppId, FString ItemId, FString Quantity, FString SteamId, FString RequestId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|InventoryService")
	void ExchangeItem(const FOnOrionSteamWebAPICallback& Callback, FString Key, int32 AppId, FString SteamId, TArray<int64> MaterialsItemID, TArray<int32> MaterialsQuantity, int64 OutputItemdefId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|InventoryService")
	void GetInventory(const FOnOrionSteamWebAPICallback& Callback, FString Key, int32 AppId, FString SteamId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|InventoryService", meta=(AutoCreateRefTerm="itemdefIDs, workshopIDs"))
	void GetItemDefs(const FOnOrionSteamWebAPICallback& Callback, FString Key, int32 AppId, FString ModifiedSince, TArray<int32> ItemdefIDs, TArray<int32> WorkshopIDs, int32 CacheMaxAgeSeconds);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|InventoryService")
	void GetPriceSheet(const FOnOrionSteamWebAPICallback& Callback, FString Key, int32 Currency);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|InventoryService")
	void Consolidate(const FOnOrionSteamWebAPICallback& Callback, FString Key, int32 AppId, FString SteamId, TArray<int32> ItemdefIDs, bool bForce);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|InventoryService")
	void GetQuantity(const FOnOrionSteamWebAPICallback& Callback, FString Key, int32 AppId, FString SteamId, TArray<int32> ItemdefIDs, bool bForce);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|InventoryService")
	void ModifyItems(const FOnOrionSteamWebAPICallback& Callback, FString Key, int32 AppId, FString SteamId, FModifyItemsItem Updates);
};
