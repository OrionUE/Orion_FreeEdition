...
UCLASS()
class ORIONSTEAMWEBAPI_API UWebCheatReporting : public UOrionSteamWebAPISubsystem
{
	GENERATED_BODY()
public:
	UWebCheatReporting()
	{
		SubsystemType = ESubsystemWeb::CheatReporting;
	}
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|CheatReporting")
	void ReportPlayerCheating(const FOnOrionSteamWebAPICallback& Callback, FString Key, int32 AppId, FString SteamId, FString SteamIdReporter, FString AppData, bool bHeuristic, bool bDetection, bool bPlayerReport, bool bNoReportID, int32 GameMode, int32 SuspicionStartTime, int32 Severity);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|CheatReporting")
	void RequestPlayerGameBan(const FOnOrionSteamWebAPICallback& Callback, FString Key, FString SteamId, int32 AppId, FString ReportID, FString CheatDescription, int32 Duration, bool bDelayBan);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|CheatReporting")
	void RemovePlayerGameBan(const FOnOrionSteamWebAPICallback& Callback, FString Key, FString SteamId, int32 AppId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|CheatReporting")
	void GetCheatingReports(const FOnOrionSteamWebAPICallback& Callback, FString Key, int32 AppId, int32 TimeEnd, int32 TimeBegin, FString ReportIdmin = "0", bool bIncludeReports = false, bool bIncludeBans = false, FString SteamId = "");
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|CheatReporting")
	void ReportCheatData(const FOnOrionSteamWebAPICallback& Callback, FString Key, FString SteamId, int32 AppId, FString PathAndFileName, FString WebCheatURL, FString TimeNow, FString TimeStarted, FString TimeStopped, FString CheatName, int32 GameProcessId, int32 CheatProcessId, FString CheatParam1, FString CheatParam2);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|CheatReporting")
	void RequestVacStatusForUser(const FOnOrionSteamWebAPICallback& Callback, FString Key, FString SteamId, int32 AppId, FString SessionID);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|CheatReporting")
	void StartSecureMultiplayerSession(const FOnOrionSteamWebAPICallback& Callback, FString Key, FString SteamId, int32 AppId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|CheatReporting")
	void EndSecureMultiplayerSession(const FOnOrionSteamWebAPICallback& Callback, FString Key, FString SteamId, int32 AppId, FString SessionID);
};
