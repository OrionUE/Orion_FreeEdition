...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionReportPlayerCheating : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Report Player Cheating", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|CheatReporting|Async")
	static UOrionSteamWebAPIAsyncActionReportPlayerCheating* ReportPlayerCheatingAsync(UObject* WorldContextObject, FString Key, int32 AppId, FString SteamId, FString SteamIdReporter, FString AppData, bool bHeuristic, bool bDetection, bool bPlayerReport, bool bNoReportID, int32 GameMode, int32 SuspicionStartTime, int32 Severity);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionRequestPlayerGameBan : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Request Player Game Ban", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|CheatReporting|Async")
	static UOrionSteamWebAPIAsyncActionRequestPlayerGameBan* RequestPlayerGameBanAsync(UObject* WorldContextObject, FString Key, FString SteamId, int32 AppId, FString ReportID, FString CheatDescription, int32 Duration, bool bDelayBan);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionRemovePlayerGameBan : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 * @param	AppId			The App ID for the game.
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Remove Player Game Ban", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|CheatReporting|Async")
	static UOrionSteamWebAPIAsyncActionRemovePlayerGameBan* RemovePlayerGameBanAsync(UObject* WorldContextObject, FString Key, FString SteamId, int32 AppId);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionGetCheatingReports : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Get Cheating Reports", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|CheatReporting|Async")
	static UOrionSteamWebAPIAsyncActionGetCheatingReports* GetCheatingReportsAsync(UObject* WorldContextObject, FString Key, int32 AppId, int32 TimeEnd, int32 TimeBegin, FString ReportIdmin, bool bIncludeReports, bool bIncludeBans, FString SteamId);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionReportCheatData : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Report Cheat Data", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|CheatReporting|Async")
	static UOrionSteamWebAPIAsyncActionReportCheatData* ReportCheatDataAsync(UObject* WorldContextObject, FString Key, FString SteamId, int32 AppId, FString PathAndFileName, FString WebCheatURL, FString TimeNow, FString TimeStarted, FString TimeStopped, FString CheatName, int32 GameProcessId, int32 CheatProcessId, FString CheatParam1, FString CheatParam2);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionRequestVacStatusForUser : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Request VAC Status for User", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|CheatReporting|Async")
	static UOrionSteamWebAPIAsyncActionRequestVacStatusForUser* RequestVacStatusForUserAsync(UObject* WorldContextObject, FString Key, FString SteamId, int32 AppId, FString SessionId);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionStartSecureMultiplayerSession : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 * @param	AppId			The App ID for the game.
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Start Secure Multiplayer Session", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|CheatReporting|Async")
	static UOrionSteamWebAPIAsyncActionStartSecureMultiplayerSession* StartSecureMultiplayerSessionAsync(UObject* WorldContextObject, FString Key, FString SteamId, int32 AppId);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionEndSecureMultiplayerSession : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 * @param	SessionId (int64)	The Session ID that was obtained from the call to StartSecureMultiplayerSession.
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="End Secure Multiplayer Session", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|CheatReporting|Async")
	static UOrionSteamWebAPIAsyncActionEndSecureMultiplayerSession* EndSecureMultiplayerSessionAsync(UObject* WorldContextObject, FString Key, FString SteamId, int32 AppId, FString SessionId);
};
