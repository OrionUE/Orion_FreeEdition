...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionAdjustAgreement : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Adjust Agreement", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|MicroTxn|Async")
	static UOrionSteamWebAPIAsyncActionAdjustAgreement* AdjustAgreementAsync(UObject* WorldContextObject, FString Key, FString SteamId, FString AgreementId, int32 AppId, FString NextProcessDate);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionCancelAgreement : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 * @param	AppId				App ID of the game the agreement is for.
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Cancel Agreement", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|MicroTxn|Async")
	static UOrionSteamWebAPIAsyncActionCancelAgreement* CancelAgreementAsync(UObject* WorldContextObject, FString Key, FString SteamId, FString AgreementId, int32 AppId);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionFinalizeTxn : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Finalize Txn", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|MicroTxn|Async")
	static UOrionSteamWebAPIAsyncActionFinalizeTxn* FinalizeTxnAsync(UObject* WorldContextObject, FString Key, FString OrderId, int32 AppId);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionGetReport : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Get Report", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|MicroTxn|Async")
	static UOrionSteamWebAPIAsyncActionGetReport* GetReportAsync(UObject* WorldContextObject, FString Key, int32 AppId, FString Time = "2010-01-01T00:00:00Z", FString Type = "GAMESALES", int32 MaxResults = 1000);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionGetUserAgreementInfo : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 * @param	AppId				App ID for game.
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Get User Agreement Info", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|MicroTxn|Async")
	static UOrionSteamWebAPIAsyncActionGetUserAgreementInfo* GetUserAgreementInfoAsync(UObject* WorldContextObject, FString Key, FString SteamId, int32 AppId);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionGetUserInfo : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Get User Info", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|MicroTxn|Async")
	static UOrionSteamWebAPIAsyncActionGetUserInfo* GetUserInfoAsync(UObject* WorldContextObject, FString Key, FString SteamId, FString Ipaddress);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionInitTxn : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionProcessAgreement : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Process Agreement"), Category="OrionSteamWebAPI|MicroTxn|Async")
	static UOrionSteamWebAPIAsyncActionProcessAgreement* ProcessAgreementAsync(UObject* WorldContextObject, FString Key, FString OrderId, FString SteamId, FString AgreementId, int32 AppId, int32 Amount, FString Currency);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionQueryTxn : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Query Txn"), Category="OrionSteamWebAPI|MicroTxn|Async")
	static UOrionSteamWebAPIAsyncActionQueryTxn* QueryTxnAsync(UObject* WorldContextObject, FString Key, int32 AppId, FString OrderId, FString TransId);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionRefundTxn : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 * @param	transID				Unique 64-bit Steam transaction ID.
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Refund Txn"), Category="OrionSteamWebAPI|MicroTxn|Async")
	static UOrionSteamWebAPIAsyncActionRefundTxn* RefundTxnAsync(UObject* WorldContextObject, FString Key, FString OrderId, int32 AppId);
};
