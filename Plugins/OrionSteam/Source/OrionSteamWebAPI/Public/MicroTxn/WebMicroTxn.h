...
UCLASS()
class ORIONSTEAMWEBAPI_API UWebMicroTxn : public UOrionSteamWebAPISubsystem
{
	GENERATED_BODY()
public:
	UWebMicroTxn()
	{
		SubsystemType = ESubsystemWeb::MicroTxn;
	}
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|MicroTxn")
	void AdjustAgreement(const FOnOrionSteamWebAPICallback& Callback, FString Key, FString SteamId, FString AgreementId, int32 AppId, FString NextProcessDate);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|MicroTxn")
	void CancelAgreement(const FOnOrionSteamWebAPICallback& Callback, FString Key, FString SteamId, FString AgreementId, int32 AppId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|MicroTxn")
	void FinalizeTxn(const FOnOrionSteamWebAPICallback& Callback, FString Key, FString OrderId, int32 AppId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|MicroTxn")
	void GetReport(const FOnOrionSteamWebAPICallback& Callback, FString Key, int32 AppId, FString Time = "2010-01-01T00:00:00Z", FString Type = "GAMESALES", int32 MaxResults = 1000);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|MicroTxn")
	void GetUserAgreementInfo(const FOnOrionSteamWebAPICallback& Callback, FString Key, FString SteamId, int32 AppId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|MicroTxn")
	void GetUserInfo(const FOnOrionSteamWebAPICallback& Callback, FString Key, FString SteamId, FString Ipaddress);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|MicroTxn")
	void ProcessAgreement(const FOnOrionSteamWebAPICallback& Callback, FString Key, FString OrderId, FString SteamId, FString AgreementId, int32 AppId, int32 Amount, FString Currency);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|MicroTxn")
	void QueryTxn(const FOnOrionSteamWebAPICallback& Callback, FString Key, int32 AppId, FString OrderId, FString TransId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|MicroTxn")
	void RefundTxn(const FOnOrionSteamWebAPICallback& Callback, FString Key, FString OrderId, int32 AppId);
