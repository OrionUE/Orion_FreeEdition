...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionCreateSession : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Create Session", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|GameNotificationsService|Async")
	static UOrionSteamWebAPIAsyncActionCreateSession* CreateSessionAsync(UObject* WorldContextObject, FString Key, int32 AppId, FString Context, FString Title, FString Users, FString SteamId);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionUpdateSession : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Update Session", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|GameNotificationsService|Async")
	static UOrionSteamWebAPIAsyncActionUpdateSession* UpdateSessionAsync(UObject* WorldContextObject, FString Key, FString SessionId, int32 AppId, FString Title, FString Users, FString SteamId);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionEnumerateSessionsForApp : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Enumerate Sessions for App", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|GameNotificationsService|Async")
	static UOrionSteamWebAPIAsyncActionEnumerateSessionsForApp* EnumerateSessionsForAppAsync(UObject* WorldContextObject, FString Key, int32 AppId, FString SteamId, bool bIncludeAllUserMessages, bool bIncludeAuthUserMessage, FString Language);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionGetSessionDetailsForApp : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Get Session Details for App", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|GameNotificationsService|Async")
	static UOrionSteamWebAPIAsyncActionGetSessionDetailsForApp* GetSessionDetailsForAppAsync(UObject* WorldContextObject, FString Key, FString sessions, int32 AppId, FString Language);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionRequestNotifications : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Request Notifications", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|GameNotificationsService|Async")
	static UOrionSteamWebAPIAsyncActionRequestNotifications* RequestNotificationsAsync(UObject* WorldContextObject, FString Key, FString SteamId, int32 AppId);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionDeleteSession : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 * @param	SteamId				(Optional) Steam ID to make the request on behalf of -- if specified, the user must be in the session.
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Delete Session", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|GameNotificationsService|Async")
	static UOrionSteamWebAPIAsyncActionDeleteSession* DeleteSessionAsync(UObject* WorldContextObject, FString Key, FString SessionId, int32 AppId, FString SteamId);
};
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS()
class ORIONSTEAMWEBAPI_API UOrionSteamWebAPIAsyncActionDeleteSessionBatch : public UOrionSteamWebAPIAsyncAction
{
	GENERATED_BODY()
public:
	/**
	 ...
	 * @param	AppId				The App ID of the session to delete.
	 */
	UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject", DisplayName="Delete Session Batch", BlueprintInternalUseOnly="true"), Category="OrionSteamWebAPI|GameNotificationsService|Async")
	static UOrionSteamWebAPIAsyncActionDeleteSessionBatch* DeleteSessionBatchAsync(UObject* WorldContextObject, FString Key, FString SessionId, int32 AppId);
};
