...
UCLASS()
class ORIONSTEAMWEBAPI_API UWebGameNotificationsService : public UOrionSteamWebAPISubsystem
{
	GENERATED_BODY()
public:
	UWebGameNotificationsService()
	{
		SubsystemType = ESubsystemWeb::GameNotifications;
	}
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|GameNotificationsService")
	void CreateSession(const FOnOrionSteamWebAPICallback& Callback, FString Key, int32 AppId, FString Context, FString Title, FString Users, FString SteamId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|GameNotificationsService")
	void UpdateSession(const FOnOrionSteamWebAPICallback& Callback, FString Key, FString SessionId, int32 AppId, FString Title, FString Users, FString SteamId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|GameNotificationsService")
	void EnumerateSessionsForApp(const FOnOrionSteamWebAPICallback& Callback, FString Key, int32 AppId, FString SteamId, bool bIncludeAllUserMessages, bool bIncludeAuthUserMessage, FString Language);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|GameNotificationsService")
	void GetSessionDetailsForApp(const FOnOrionSteamWebAPICallback& Callback, FString Key, FString Sessions, int32 AppId, FString Language);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|GameNotificationsService")
	void RequestNotifications(const FOnOrionSteamWebAPICallback& Callback, FString Key, FString SteamId, int32 AppId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|GameNotificationsService")
	void DeleteSession(const FOnOrionSteamWebAPICallback& Callback, FString Key, FString SessionId, int32 AppId, FString SteamId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|GameNotificationsService")
	void DeleteSessionBatch(const FOnOrionSteamWebAPICallback& Callback, FString Key, FString SessionId, int32 AppId);
};
