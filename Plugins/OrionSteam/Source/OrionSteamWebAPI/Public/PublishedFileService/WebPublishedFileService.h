...
UCLASS()
class ORIONSTEAMWEBAPI_API UWebPublishedFileService : public UOrionSteamWebAPISubsystem
{
	GENERATED_BODY()
public:
	UWebPublishedFileService()
	{
		SubsystemType = ESubsystemWeb::PublishedFile;
	}
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|PublishedFileService")
	void QueryFiles(const FOnOrionSteamWebAPICallback& Callback, FString Key, int32 QueryType, int32 Page, FString Cursor, int32 NumPerPage, int32 CreatorAppId, int32 AppId, FString RequiredTags, FString ExcludedTags, bool bMatchAllTags, FString RequiredFlags, FString OmittedFlags, FString SearchText, int32 FileType, FString ChildPublishedFileId, int32 Days, bool bIncludeRecentVotesOnly, int32 CacheMaxAgeSeconds, int32 Language, FString RequiredKvTags, bool bTotalOnly, bool bIDsOnly, bool bReturnVoteData, bool bReturnTags, bool bReturnKvTags, bool bReturnPreviews, bool bReturnChildren, bool bReturnShortDescription, bool bReturnForSaleData, bool bReturnMetaData, int32 ReturnPlaytimeStats);
	...
	*/
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|PublishedFileService")
	void SetDeveloperMetadata(const FOnOrionSteamWebAPICallback& Callback, FString Key, FString PublishedFileId, int32 AppId, FString MetaData);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|PublishedFileService")
	void UpdateBanStatus(const FOnOrionSteamWebAPICallback& Callback, FString Key, FString PublishedFileId, int32 AppId, bool bBanned, FString Reason);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|PublishedFileService")
	void UpdateIncompatibleStatus(const FOnOrionSteamWebAPICallback& Callback, FString Key, FString PublishedFileId, int32 AppId, bool bIncompatible);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|PublishedFileService")
	void UpdateTags(const FOnOrionSteamWebAPICallback& Callback, FString Key, FString PublishedFileId, int32 AppId, FString AddTags, FString RemoveTags);
};
