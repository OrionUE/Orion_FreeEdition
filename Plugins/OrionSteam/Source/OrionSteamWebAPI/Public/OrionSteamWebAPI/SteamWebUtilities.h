...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
UCLASS(abstract)
class ORIONSTEAMWEBAPI_API USteamWebUtilities : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|Utilities")
	static bool ParseJson(const FString& JSONString, TArray<FOrionSteamJson>& Data);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteamWebAPI|Utilities", meta=(ExpandEnumAsExecs=Result))
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, Category="OrionSteamWebAPI|Utilities")
