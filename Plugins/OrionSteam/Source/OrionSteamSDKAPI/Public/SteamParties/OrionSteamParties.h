...
#include "OrionSteamParties.generated.h"
 ...
 */
UCLASS()
class ORIONSTEAMSDKAPI_API UOrionSteamParties : public UOrionSteamInterface
{
	GENERATED_BODY()
public:
	UOrionSteamParties();
	virtual ~UOrionSteamParties() override;

	UFUNCTION(BlueprintCallable, BlueprintPure, Category="OrionSteam")
	static UOrionSteamParties* GetSteamParties();

public:
	UPROPERTY(BlueprintAssignable, Category="OrionSteam|SteamParties|Delegates")
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|SteamParties|Client")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|SteamParties|Host")
...
#if WITH_ORIONSTEAM
	STEAM_CALLBACK_MANUAL(UOrionSteamParties, OnJoinPartyUpdated, JoinPartyCallback_t, OnJoinPartyCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamParties, OnCreateBeaconUpdated, CreateBeaconCallback_t, OnCreateBeaconCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamParties, OnReservationNotificationUpdated, ReservationNotificationCallback_t, OnReservationNotificationCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamParties, OnChangeNumOpenSlotsUpdated, ChangeNumOpenSlotsCallback_t, OnChangeNumOpenSlotsCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamParties, OnAvailableBeaconLocationsUpdated, AvailableBeaconLocationsUpdated_t, OnAvailableBeaconLocationsCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamParties, OnActiveBeaconsUpdated, ActiveBeaconsUpdated_t, OnActiveBeaconsCallback);
#endif
};
