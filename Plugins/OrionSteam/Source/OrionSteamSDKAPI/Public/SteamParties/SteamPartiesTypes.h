...
public:
	...
	FSteamPartyBeaconLocation(const SteamPartyBeaconLocation_t& Data)
		: Type(static_cast<ESteamPartiesBeaconLocationType>(Data.m_eType)), LocationId(LexToString(Data.m_ulLocationID))
	{
	}
#endif
...
public:
	...
	FJoinPartyData(const JoinPartyCallback_t& Data)
		: Result(_SteamResult(Data.m_eResult)), BeaconID(Data.m_ulBeaconID), SteamIDBeaconOwner(Data.m_SteamIDBeaconOwner), ConnectString(UTF8_TO_TCHAR(Data.m_rgchConnectString))
	{
	}
#endif
};
...
public:
	...
	FCreateBeaconData(const CreateBeaconCallback_t& Data)
		: Result(_SteamResult(Data.m_eResult)), BeaconID(Data.m_ulBeaconID)
	{
	}
#endif
};
...
public:
	...
	FReservationNotificationData(const ReservationNotificationCallback_t& Data)
		: BeaconId(Data.m_ulBeaconID), SteamIDJoiner(Data.m_steamIDJoiner)
	{
	}
#endif
};
