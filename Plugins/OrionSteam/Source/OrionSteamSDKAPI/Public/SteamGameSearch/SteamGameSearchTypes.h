...
public:
	FSearchForGameProgressCallback()
		: Result(ESteamResult::None), SecondsRemainingEstimate(0), PlayersSearching(0)
	{
	}

#if WITH_ORIONSTEAM
	FSearchForGameProgressCallback(const SearchForGameProgressCallback_t& Data)
		: SearchID(LexToString(Data.m_ullSearchID)), Result(_SteamResult(Data.m_eResult)), LobbyID(Data.m_lobbyID), SteamIDEndedSearch(Data.m_steamIDEndedSearch), SecondsRemainingEstimate(Data.m_nSecondsRemainingEstimate), PlayersSearching(Data.m_cPlayersSearching)
	{
	}
#endif
...
public:
	FSearchForGameResultCallback()
		: Result(ESteamResult::None), CountPlayersInGame(0), CountAcceptedGame(0), bFinalCallback(false)
	{
	}

#if WITH_ORIONSTEAM
	FSearchForGameResultCallback(const SearchForGameResultCallback_t& Data)
		: SearchID(LexToString(Data.m_ullSearchID)), Result(_SteamResult(Data.m_eResult)), CountPlayersInGame(Data.m_nCountPlayersInGame), CountAcceptedGame(Data.m_nCountAcceptedGame), SteamIDHost(Data.m_steamIDHost), bFinalCallback(Data.m_bFinalCallback)
	{
	}
#endif
...
public:
	...
	FRequestPlayersForGameProgressCallback(const RequestPlayersForGameProgressCallback_t& Data)
		: Result(_SteamResult(Data.m_eResult)), SearchID(LexToString(Data.m_ullSearchID))
	{
	}
#endif
...
public:
	FRequestPlayersForGameResultCallback()
		: Result(ESteamResult::None), PlayerAcceptState(ESteamPlayerAcceptState::Unknown), PlayerIndex(0), TotalPlayersFound(0), TotalPlayersAcceptedGame(0), SuggestedTeamIndex(0)
	{
	}

#if WITH_ORIONSTEAM
	FRequestPlayersForGameResultCallback(const RequestPlayersForGameResultCallback_t& Data)
		: Result(_SteamResult(Data.m_eResult)), SearchID(LexToString(Data.m_ullSearchID)), SteamIDPlayerFound(Data.m_SteamIDPlayerFound), SteamIDLobby(Data.m_SteamIDLobby), PlayerAcceptState(static_cast<ESteamPlayerAcceptState>(Data.m_ePlayerAcceptState)), PlayerIndex(Data.m_nPlayerIndex), TotalPlayersFound(Data.m_nTotalPlayersFound), TotalPlayersAcceptedGame(Data.m_nTotalPlayersAcceptedGame), SuggestedTeamIndex(Data.m_nSuggestedTeamIndex), UniqueGameID(LexToString(Data.m_ullUniqueGameID))
	{
	}
#endif
...
public:
	...
	FRequestPlayersForGameFinalResultCallback(const RequestPlayersForGameFinalResultCallback_t& Data)
		: Result(_SteamResult(Data.m_eResult)), SearchID(LexToString(Data.m_ullSearchID)), UniqueGameID(LexToString(Data.m_ullUniqueGameID))
	{
	}
#endif
...
public:
	...
	FSubmitPlayerResultResultCallback(const SubmitPlayerResultResultCallback_t& Data)
		: Result(_SteamResult(Data.m_eResult)), UniqueGameID(LexToString(Data.ullUniqueGameID)), SteamIDPlayer(Data.steamIDPlayer)
	{
	}
#endif
...
public:
	...
	FEndGameResultCallback(const EndGameResultCallback_t& Data)
		: Result(_SteamResult(Data.m_eResult)), UniqueGameID(LexToString(Data.ullUniqueGameID))
	{
	}
#endif
