...
UCLASS()
class ORIONSTEAMSDKAPI_API UOrionSteamGameServerStats : public UOrionSteamInterface
{
	GENERATED_BODY()
public:
	UOrionSteamGameServerStats();
	virtual ~UOrionSteamGameServerStats() override;

	UFUNCTION(BlueprintCallable, BlueprintPure, Category="OrionSteam")
	static UOrionSteamGameServerStats* GetSteamGameServerStats();

public:
	UPROPERTY(BlueprintAssignable, Category="OrionSteam|GameServerStats|Delegates")
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|GameServerStats")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|GameServerStats", meta=(AutoCreateRefTerm="callback"))
...
private:
	...
	// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
#if WITH_ORIONSTEAM
	STEAM_CALLBACK_MANUAL(UOrionSteamGameServerStats, OnGSStatsUnloaded, GSStatsUnloaded_t, OnGSStatsUnloadedCallback);
#endif
};
