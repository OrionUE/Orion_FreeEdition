...
UCLASS()
class ORIONSTEAMSDKAPI_API UOrionSteamUGC : public UOrionSteamInterface
{
	GENERATED_BODY()
public:
	UOrionSteamUGC();
	virtual ~UOrionSteamUGC() override;

	UFUNCTION(BlueprintCallable, BlueprintPure, Category="OrionSteam")
	static UOrionSteamUGC* GetSteamUGC();

public:
	UPROPERTY(BlueprintAssignable, Category="OrionSteam|UGC|Delegates")
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|UGC", meta=(AutoCreateRefTerm="Callback"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|UGC")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|UGC")
	static int32 GetSubscribedItems(TArray<FPublishedFileID>& PublishedFileIDs, int32 MaxEntries, bool bIncludeLocallyDisabled);
	...
	/*
	 * An empty string for either parameter means that it will match any version on that end of the range.
	 * This will only be applied if the actual content has been changed.
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|UGC")
	static bool SetRequiredGameVersions(FUGCUpdateHandle Handle, FString GameBranchMin, FString GameBranchMax);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|UGC")
	static bool SetItemsDisabledLocally(TArray<FPublishedFileID> PublishedFileIDs, bool bDisabledLocally);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|UGC")
	static bool SetSubscriptionsLoadOrder(TArray<FPublishedFileID> PublishedFileIDs);
...
#if WITH_ORIONSTEAM
	STEAM_CALLBACK_MANUAL(UOrionSteamUGC, OnDownloadItemResult, DownloadItemResult_t, OnDownloadItemResultCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamUGC, OnItemInstalled, ItemInstalled_t, OnItemInstalledCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamUGC, OnUserSubscribedItemsListChanged, UserSubscribedItemsListChanged_t, OnUserSubscribedItemsListChangedCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamUGC, OnWorkshopEULAStatus, WorkshopEULAStatus_t, OnWorkshopEULAStatusCallback);
#endif
};
