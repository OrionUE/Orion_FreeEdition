...
UCLASS()
class ORIONSTEAMSDKAPI_API UOrionSteamUser : public UOrionSteamInterface
{
	GENERATED_BODY()
public:
	UOrionSteamUser();
	virtual ~UOrionSteamUser() override;

	UFUNCTION(BlueprintCallable, BlueprintPure, Category="OrionSteam")
	static UOrionSteamUser* GetSteamUser();

public:
	UPROPERTY(BlueprintAssignable, Category="OrionSteam|User|Delegates")
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|User")
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure, Category="OrionSteam|User", meta=(DisplayName="Get Steam ID (Pure)"))
	 ...
	 * A Steam ID is a unique identifier for a Steam accounts, Steam groups, Lobbies and Chat rooms, and used to differentiate users in all parts of the Steamworks API.
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|User", meta=(DisplayName="Get SteamId as String"))
...
#if WITH_ORIONSTEAM
	STEAM_CALLBACK_MANUAL(UOrionSteamUser, OnClientGameServerDeny, ClientGameServerDeny_t, OnClientGameServerDenyCallbackCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamUser, OnGameWebCallback, GameWebCallback_t, OnGameWebCallbackCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamUser, OnGetAuthSessionTicketResponse, GetAuthSessionTicketResponse_t, OnGetAuthSessionTicketResponseCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamUser, OnIPCFailure, IPCFailure_t, OnIPCFailureCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamUser, OnLicensesUpdated, LicensesUpdated_t, OnLicensesUpdatedCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamUser, OnMicroTxnAuthorizationResponse, MicroTxnAuthorizationResponse_t, OnMicroTxnAuthorizationResponseCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamUser, OnSteamServersConnected, SteamServersConnected_t, OnSteamServersConnectedCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamUser, OnSteamServerConnectFailure, SteamServerConnectFailure_t, OnSteamServerConnectFailureCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamUser, OnSteamServersDisconnected, SteamServersDisconnected_t, OnSteamServersDisconnectedCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamUser, OnValidateAuthTicketResponse, ValidateAuthTicketResponse_t, OnValidateAuthTicketResponseCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamUser, OnEncryptedAppTicketResponse, EncryptedAppTicketResponse_t, OnEncryptedAppTicketResponseCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamUser, OnGetTicketForWebApiResponse, GetTicketForWebApiResponse_t, OnGetTicketForWebApiResponseCallback);
#endif
};
