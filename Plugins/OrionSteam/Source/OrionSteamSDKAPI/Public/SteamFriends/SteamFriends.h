...
UCLASS()
class ORIONSTEAMSDKAPI_API UOrionSteamFriends : public UOrionSteamInterface
{
	GENERATED_BODY()
public:
	UOrionSteamFriends();
	virtual ~UOrionSteamFriends() override;

	UFUNCTION(BlueprintCallable, BlueprintPure, Category="OrionSteam")
	static UOrionSteamFriends* GetSteamFriends();

public:
	UPROPERTY(BlueprintAssignable, Category="OrionSteam|Friends|Delegates")
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|Friends", meta=(AutoCreateRefTerm="Callback"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure, Category="OrionSteam|Friends", meta=(DisplayName="Get Persona Name (Pure)"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure, Category="OrionSteam|Friends", meta=(DisplayName="Get Persona State (Pure)"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure, Category="OrionSteam|Friends", meta=(DisplayName="Get Player Nickname (Pure)"))
	static FString GetPlayerNickname_Pure(FSteamID steamIDPlayer)
	{
		return GetPlayerNickname(steamIDPlayer);
	}
...
#if WITH_ORIONSTEAM
	STEAM_CALLBACK_MANUAL(UOrionSteamFriends, OnAvatarImageLoaded, AvatarImageLoaded_t, OnAvatarImageLoadedCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamFriends, OnFriendRichPresenceUpdate, FriendRichPresenceUpdate_t, OnFriendRichPresenceUpdateCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamFriends, OnGameConnectedChatJoin, GameConnectedChatJoin_t, OnGameConnectedChatJoinCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamFriends, OnGameConnectedChatLeave, GameConnectedChatLeave_t, OnGameConnectedChatLeaveCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamFriends, OnGameConnectedFriendChatMsg, GameConnectedFriendChatMsg_t, OnGameConnectedFriendChatMsgCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamFriends, OnGameConnectedClanChatMsg, GameConnectedClanChatMsg_t, OnGameConnectedClanChatMsgCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamFriends, OnGameLobbyJoinRequested, GameLobbyJoinRequested_t, OnGameLobbyJoinRequestedCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamFriends, OnGameOverlayActivated, GameOverlayActivated_t, OnGameOverlayActivatedCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamFriends, OnGameRichPresenceJoinRequested, GameRichPresenceJoinRequested_t, OnGameRichPresenceJoinRequestedCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamFriends, OnGameServerChangeRequested, GameServerChangeRequested_t, OnGameServerChangeRequestedCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamFriends, OnPersonaStateChange, PersonaStateChange_t, OnPersonaStateChangeCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamFriends, OnJoinClanChatRoomCompletionResult, JoinClanChatRoomCompletionResult_t, OnJoinClanChatRoomCompletionResultCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamFriends, OnClanOfficerListResponse, ClanOfficerListResponse_t, OnClanOfficerListResponseCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamFriends, OnDownloadClanActivityCountsResult, DownloadClanActivityCountsResult_t, OnDownloadClanActivityCountsResultCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamFriends, OnEquippedProfileItemsChanged, EquippedProfileItemsChanged_t, OnEquippedProfileItemsChangedCallback);
#endif
