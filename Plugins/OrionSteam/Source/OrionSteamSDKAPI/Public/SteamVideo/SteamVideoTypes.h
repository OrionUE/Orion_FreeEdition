...
public:
	FGetOPFSettingsResult()
		: Result(ESteamResult::None), AppID(0)
	{
	}

#if WITH_ORIONSTEAM
	FGetOPFSettingsResult(const GetOPFSettingsResult_t& Data)
		: Result(_SteamResult(Data.m_eResult)), AppID(Data.m_unVideoAppID)
	{
	}
#endif
...
public:
	...
	FGetVideoURLResult(const GetVideoURLResult_t& Data)
		: Result(_SteamResult(Data.m_eResult)), AppID(Data.m_unVideoAppID), URL(UTF8_TO_TCHAR(Data.m_rgchURL))
	{
	}
#endif
