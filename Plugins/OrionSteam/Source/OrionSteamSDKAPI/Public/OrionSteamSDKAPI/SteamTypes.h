...
//		Structs
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
USTRUCT(BlueprintType, meta=(HasNativeMake="/Script/OrionSteam.OrionSteamUtilities:MakeSteamID", HasNativeBreak="/Script/OrionSteam.OrionSteamUtilities:BreakSteamID"))
struct ORIONSTEAMSDKAPI_API FSteamID
{
	GENERATED_BODY()
public:
	FSteamID()
...
public:
	...
	void operator=(const CSteamID& Data)
	{
		m_Value = Data.ConvertToUint64();
	}
#endif
	bool operator==(const FSteamID& Data)
	{
		return Data == m_Value;
	}
	bool operator!=(const FSteamID& Data)
...
USTRUCT(BlueprintType, meta=(HasNativeMake="/Script/OrionSteam.OrionSteamUtilities:MakeSteamGameID", HasNativeBreak="/Script/OrionSteam.OrionSteamUtilities:BreakSteamGameID"))
struct ORIONSTEAMSDKAPI_API FSteamGameID
{
	GENERATED_BODY()
public:
	FSteamGameID()
...
#if WITH_ORIONSTEAM
	operator CGameID() const
	{
		return CGameID(m_Value);
	}
	void operator=(const CGameID& Data)
	{
		m_Value = Data.ToUint64();
	}
	bool operator==(const CGameID& Data)
	{
		return Data.ToUint64() == m_Value;
	}
#endif
public:
	uint64 GetValue() const
...
USTRUCT(BlueprintType, meta=(HasNativeMake="/Script/OrionSteam.OrionSteamUtilities:MakeUGCHandle", HasNativeBreak="/Script/OrionSteam.OrionSteamUtilities:BreakUGCHandle"))
struct ORIONSTEAMSDKAPI_API FSteamUGCHandle
{
	GENERATED_BODY()
public:
	FSteamUGCHandle()
...
USTRUCT(BlueprintType, meta=(HasNativeMake="/Script/OrionSteam.OrionSteamUtilities:MakeInventoryUpdateHandle", HasNativeBreak="/Script/OrionSteam.OrionSteamUtilities:BreakInventoryUpdateHandle"))
struct ORIONSTEAMSDKAPI_API FSteamInventoryUpdateHandle
{
	GENERATED_BODY()
public:
...
struct ORIONSTEAMSDKAPI_API FSteamNetworkingIdentity
{
	GENERATED_BODY()
...
public:
	FSteamNetworkingIdentity()
	{
		...
		m_SteamNetworkingIdentity.SetGenericString("ORIONSTEAM");
#endif
	}
...
USTRUCT(BlueprintType)
struct ORIONSTEAMSDKAPI_API FSteamTicketHandle
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType, meta=(HasNativeMake="/Script/OrionSteam.OrionSteamUtilities:MakePublishedFileID", HasNativeBreak="/Script/OrionSteam.OrionSteamUtilities:BreakPublishedFileID"))
...
public:
	...
	bool operator==(const FPublishedFileID& data)
	{
		return data.GetValue() == m_Value;
	}
	bool operator!=(const FPublishedFileID& data)
	{
		return data.GetValue() != m_Value;
...
public:
	...
	FSteamSessionResult(const FBlueprintSessionResult& InResult, const TArray<FSteamSessionSetting>& InSessionSettings)
		: Result(InResult), SessionSettings(InSessionSettings), bPasswordedSession(false)
	{
	}
...
public:
	...
	bool operator==(const FPartyBeaconID& Data)
	{
		return Data.GetValue() == m_Value;
	}
	bool operator!=(const FPartyBeaconID& Data)
