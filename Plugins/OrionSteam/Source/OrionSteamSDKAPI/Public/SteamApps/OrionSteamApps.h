...
#include "OrionSteamApps.generated.h"

UCLASS()
class ORIONSTEAMSDKAPI_API UOrionSteamApps : public UOrionSteamInterface
{
	GENERATED_BODY()
public:
	UOrionSteamApps();
	virtual ~UOrionSteamApps() override;

	UFUNCTION(BlueprintCallable, BlueprintPure, Category="OrionSteam")
	static UOrionSteamApps* GetSteamApps();

public:
	UPROPERTY(BlueprintAssignable, Category="OrionSteam|Apps|Delegates")
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|Apps")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|Apps")
	static int GetNumBetas(int32& Available, int32& Private);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|Apps")
	static bool SetActiveBeta(FString BetaName);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|Apps", meta=(AutoCreateRefTerm="Callback"))
...
private:
	...
	// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
#if WITH_ORIONSTEAM
	STEAM_CALLBACK_MANUAL(UOrionSteamApps, OnDLCInstalled, DlcInstalled_t, OnDLCInstalledCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamApps, OnFileDetailsResult, FileDetailsResult_t, OnFileDetailsResultCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamApps, OnNewUrlLaunchParameters, NewUrlLaunchParameters_t, OnNewUrlLaunchParametersCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamApps, OnTimedTrialStatus, TimedTrialStatus_t, OnTimedTrialStatusCallback);
#endif
};
