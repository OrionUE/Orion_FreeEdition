...
UCLASS()
class ORIONSTEAMSDKAPI_API UOrionSteamRemoteStorage : public UOrionSteamInterface
{
	GENERATED_BODY()
public:
	UOrionSteamRemoteStorage();
	virtual ~UOrionSteamRemoteStorage() override;

	UFUNCTION(BlueprintCallable, BlueprintPure, Category="OrionSteam")
	static UOrionSteamRemoteStorage* GetSteamRemoteStorage();
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|RemoteStorage")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|RemoteStorage", meta=(AutoCreateRefTerm="callback"))
...
#if WITH_ORIONSTEAM
	STEAM_CALLBACK_MANUAL(UOrionSteamRemoteStorage, OnRemoteStorageUnsubscribePublishedFileResult, RemoteStorageUnsubscribePublishedFileResult_t, OnRemoteStorageUnsubscribePublishedFileResultCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamRemoteStorage, OnRemoteStorageSubscribePublishedFileResult, RemoteStorageSubscribePublishedFileResult_t, OnRemoteStorageSubscribePublishedFileResultCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamRemoteStorage, OnRemoteStoragePublishedFileUnsubscribed, RemoteStoragePublishedFileUnsubscribed_t, OnRemoteStoragePublishedFileUnsubscribedCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamRemoteStorage, OnRemoteStoragePublishedFileSubscribed, RemoteStoragePublishedFileSubscribed_t, OnRemoteStoragePublishedFileSubscribedCallback);
#endif
};
