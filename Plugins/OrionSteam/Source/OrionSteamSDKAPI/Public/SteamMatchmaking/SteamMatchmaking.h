...
UCLASS()
class ORIONSTEAMSDKAPI_API UOrionSteamMatchmaking : public UOrionSteamInterface
{
	GENERATED_BODY()
public:
	UOrionSteamMatchmaking();
	virtual ~UOrionSteamMatchmaking() override;

	UFUNCTION(BlueprintCallable, BlueprintPure, Category="OrionSteam")
	static UOrionSteamMatchmaking* GetSteamMatchmaking();

public:
	UPROPERTY(BlueprintAssignable, Category="OrionSteam|Matchmaking|Delegates")
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|Matchmaking", meta=(AutoCreateRefTerm="Callback"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|Matchmaking")
	static bool KickLobbyMember(FSteamID LobbyId, FSteamID PlayerToKick);
...
#if WITH_ORIONSTEAM
	STEAM_CALLBACK_MANUAL(UOrionSteamMatchmaking, OnFavoritesListAccountsUpdated, FavoritesListAccountsUpdated_t, OnFavoritesListAccountsUpdatedCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamMatchmaking, OnFavoritesListChanged, FavoritesListChanged_t, OnFavoritesListChangedCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamMatchmaking, OnLobbyChatMsg, LobbyChatMsg_t, OnLobbyChatMsgCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamMatchmaking, OnLobbyChatUpdate, LobbyChatUpdate_t, OnLobbyChatUpdateCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamMatchmaking, OnLobbyDataUpdate, LobbyDataUpdate_t, OnLobbyDataUpdateCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamMatchmaking, OnLobbyEnter, LobbyEnter_t, OnLobbyEnterCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamMatchmaking, OnLobbyGameCreated, LobbyGameCreated_t, OnLobbyGameCreatedCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamMatchmaking, OnLobbyInvite, LobbyInvite_t, OnLobbyInviteCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamMatchmaking, OnLobbyKicked, LobbyKicked_t, OnLobbyKickedCallback);
#endif
};
