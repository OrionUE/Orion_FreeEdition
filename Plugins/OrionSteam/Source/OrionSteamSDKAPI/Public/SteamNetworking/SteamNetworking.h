...
UCLASS()
class ORIONSTEAMSDKAPI_API UOrionSteamNetworking : public UOrionSteamInterface
{
	GENERATED_BODY()
public:
	UOrionSteamNetworking();
	virtual ~UOrionSteamNetworking() override;

	UFUNCTION(BlueprintCallable, BlueprintPure, Category="OrionSteam")
	static UOrionSteamNetworking* GetSteamNetworking();

public:
	UPROPERTY(BlueprintAssignable, Category="OrionSteam|Networking|Delegates")
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|Networking")
...
#if WITH_ORIONSTEAM
	STEAM_CALLBACK_MANUAL(UOrionSteamNetworking, OnP2PSessionRequest, P2PSessionRequest_t, OnP2PSessionRequestCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamNetworking, OnP2PSessionConnectFail, P2PSessionConnectFail_t, OnP2PSessionConnectFailCallback);
#endif
};
