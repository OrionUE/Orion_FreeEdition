...
UCLASS()
class ORIONSTEAMSDKAPI_API UOrionSteamScreenshots : public UOrionSteamInterface
{
	GENERATED_BODY()
public:
	UOrionSteamScreenshots();
	virtual ~UOrionSteamScreenshots() override;

	UFUNCTION(BlueprintCallable, BlueprintPure, Category="OrionSteam")
	static UOrionSteamScreenshots* GetSteamScreenshots();

public:
	UPROPERTY(BlueprintAssignable, Category="OrionSteam|Screenshots|Delegates")
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|Screenshots")
...
#if WITH_ORIONSTEAM
	STEAM_CALLBACK_MANUAL(UOrionSteamScreenshots, OnScreenshotReady, ScreenshotReady_t, OnScreenshotReadyCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamScreenshots, OnScreenshotRequested, ScreenshotRequested_t, OnScreenshotRequestedCallback);
#endif
};
