...
UCLASS()
class ORIONSTEAMSDKAPI_API UOrionSteamInput : public UOrionSteamInterface
{
	GENERATED_BODY()
public:
	UOrionSteamInput();
	virtual ~UOrionSteamInput() override;

	UFUNCTION(BlueprintCallable, BlueprintPure, Category="OrionSteam")
	static UOrionSteamInput* GetSteamInput();
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|Input")
	bool Init();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|Input")
	bool SetInputActionManifestFilePath(FString InputActionManifestAbsolutePath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|Input")
	FString GetGlyphPNGForActionOrigin(int32 Origin, EOrionSteamInputGlyphSize Size, int32 Flags);

	/**
	 *  Get a local path to a SVG file for the provided origin's glyph.
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|Input")
	FString GetGlyphSVGForActionOrigin(int32 Origin, int32 Flags);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|Input")
	FString GetGlyphForActionOrigin_Legacy(int32 Origin);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|Input")
	void SetLEDColor(FInputHandle Handle, uint8 ColorR, uint8 ColorG, uint8 ColorB, EOrionSteamInputLEDFlag Flags);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|Input")
	void Legacy_TriggerHapticPulse(FInputHandle Handle, EOrionSteamControllerPad TargetPad, float DurationMicroSec);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|Input")
	void Legacy_TriggerRepeatedHapticPulse(FInputHandle Handle, EOrionSteamControllerPad TargetPad, float DurationMicroSec, float OffMicroSec, int32 Repeat, uint8 Flags);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|Input")
	EOrionSteamInputType GetInputTypeForHandle(FInputHandle Handle);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|Input")
	FString GetStringForXboxOrigin(EOrionSteamXboxOrigin Origin);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|Input")
	FString GetGlyphForXboxOrigin(EOrionSteamXboxOrigin Origin);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|Input")
	int32 GetActionOriginFromXboxOrigin(FInputHandle Handle, EOrionSteamXboxOrigin Origin);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|Input")
	int32 TranslateActionOrigin(EOrionSteamInputType DestinationInputType, int32 SourceOrigin);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|Input")
	static TArray<EOrionSteamInputConfigurationEnableType> GetSessionInputConfigurationSettings();
