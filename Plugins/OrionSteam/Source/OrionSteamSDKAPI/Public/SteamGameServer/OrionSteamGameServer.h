...
#include "OrionSteamGameServer.generated.h"

UCLASS()
class ORIONSTEAMSDKAPI_API UOrionSteamGameServer : public UOrionSteamInterface
{
	GENERATED_BODY()
public:
	UOrionSteamGameServer();
	virtual ~UOrionSteamGameServer() override;

	UFUNCTION(BlueprintCallable, BlueprintPure, Category="OrionSteam")
	static UOrionSteamGameServer* GetSteamGameServer();

public:
	UPROPERTY(BlueprintAssignable, Category="OrionSteam|GameServer|Delegates")
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|GameServer", meta=(AutoCreateRefTerm="Callback"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|GameServer")
	 ...
	 * Gets the Steam ID of the game server.
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure, Category="OrionSteam|GameServer", meta=(DisplayName="Get Server Public Ip (Pure)", Keywords="Get Ip"))
	 ...
	 * Gets the Steam ID of the game server.
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure, Category="OrionSteam|GameServer", meta=(DisplayName="Get Server Public Ip (Compact)", Keywords="Get Ip", CompactNodeTitle="Server Ip"))
	 ...
	 * Gets the Steam ID of the game server.
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure, Category="OrionSteam|GameServer", meta=(DisplayName="Get Server Steam Id (Pure)", Keywords="Get Steam Id"))
	FSteamID GetServerSteamID_Pure()
	{
		return GetServerSteamID();
	}

	/**
	 * Gets the Steam ID of the game server.
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure, Category="OrionSteam|GameServer", meta=(DisplayName="Get Server Steam Id (Compact)", Keywords="Get Steam Id", CompactNodeTitle="Server Id"))
...
#if WITH_ORIONSTEAM
	STEAM_CALLBACK_MANUAL(UOrionSteamGameServer, OnGSPolicyResponse, GSPolicyResponse_t, OnGSPolicyResponseCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamGameServer, OnGSClientGroupStatus, GSClientGroupStatus_t, OnGSClientGroupStatusCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamGameServer, OnGSValidateAuthTicketResponse, ValidateAuthTicketResponse_t, OnGSValidateAuthTicketResponseCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamGameServer, OnGSClientApprove, GSClientApprove_t, OnGSClientApproveCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamGameServer, OnGSClientDeny, GSClientDeny_t, OnGSClientDenyCallback);
#endif
};
