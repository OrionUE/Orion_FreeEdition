...
public:
	FComputeNewPlayerCompatibilityResult()
		: Result(ESteamResult::None), PlayersThatDontLikeCandidate(0), PlayersThatCandidateDoesntLike(0), ClanPlayersThatDontLikeCandidate(0)
	{
	}

#if WITH_ORIONSTEAM
	FComputeNewPlayerCompatibilityResult(const ComputeNewPlayerCompatibilityResult_t& Data)
		: Result(_SteamResult(Data.m_eResult)), PlayersThatDontLikeCandidate(Data.m_cPlayersThatDontLikeCandidate), PlayersThatCandidateDoesntLike(Data.m_cPlayersThatCandidateDoesntLike), ClanPlayersThatDontLikeCandidate(Data.m_cClanPlayersThatDontLikeCandidate), SteamIDCandidate(Data.m_SteamIDCandidate)
	{
	}
#endif
public:
