...
UCLASS()
class ORIONSTEAMSDKAPI_API UOrionSteamInventory : public UOrionSteamInterface
{
	GENERATED_BODY()
public:
	UOrionSteamInventory();
	virtual ~UOrionSteamInventory() override;

	UFUNCTION(BlueprintCallable, BlueprintPure, Category="OrionSteam")
	static UOrionSteamInventory* GetSteamInventory();

public:
	UPROPERTY(BlueprintAssignable, Category="OrionSteam|Inventory|Delegates")
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|Inventory")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|Inventory", meta=(AutoCreateRefTerm="callback"))
...
#if WITH_ORIONSTEAM
	STEAM_CALLBACK_MANUAL(UOrionSteamInventory, OnSteamInventoryDefinitionUpdate, SteamInventoryDefinitionUpdate_t, OnSteamInventoryDefinitionUpdateCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamInventory, OnSteamInventoryEligiblePromoItemDefIDs, SteamInventoryEligiblePromoItemDefIDs_t, OnSteamInventoryEligiblePromoItemDefIDsCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamInventory, OnSteamInventoryResultReady, SteamInventoryResultReady_t, OnSteamInventoryResultReadyCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamInventory, OnSteamInventoryFullUpdate, SteamInventoryFullUpdate_t, OnSteamInventoryFullUpdateCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamInventory, OnSteamInventoryStartPurchaseResult, SteamInventoryStartPurchaseResult_t, OnSteamInventoryStartPurchaseResultCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamInventory, OnSteamInventoryRequestPricesResult, SteamInventoryRequestPricesResult_t, OnSteamInventoryRequestPricesResultCallback);
#endif
};
