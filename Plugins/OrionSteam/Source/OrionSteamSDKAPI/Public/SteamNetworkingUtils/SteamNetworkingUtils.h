...
UCLASS()
class ORIONSTEAMSDKAPI_API UOrionSteamNetworkingUtils : public UOrionSteamInterface
{
	GENERATED_BODY()
public:
	UOrionSteamNetworkingUtils();
	virtual ~UOrionSteamNetworkingUtils() override;

	UFUNCTION(BlueprintCallable, BlueprintPure, Category="OrionSteam")
	static UOrionSteamNetworkingUtils* GetSteamNetworkingUtils();
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|NetworkingUtils")
