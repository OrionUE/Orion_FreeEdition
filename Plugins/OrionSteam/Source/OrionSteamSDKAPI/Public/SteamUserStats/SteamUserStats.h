...
UCLASS()
class ORIONSTEAMSDKAPI_API UOrionSteamUserStats : public UOrionSteamInterface
{
	GENERATED_BODY()
public:
	UOrionSteamUserStats();
	virtual ~UOrionSteamUserStats() override;

	UFUNCTION(BlueprintCallable, BlueprintPure, Category="OrionSteam")
	static UOrionSteamUserStats* GetSteamUserStats();

public:
	UPROPERTY(BlueprintAssignable, Category="OrionSteam|UserStats|Delegates")
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|UserStats", meta=(AutoCreateRefTerm="Callback"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|UserStats")
	 ...
	 * @param outDetails
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|UserStats", meta=(AutoCreateRefTerm="Details"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|UserStats", meta=(DeprecatedFunction))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="OrionSteam|UserStats", meta=(AutoCreateRefTerm="Callback, scoreDetails"))
...
#if WITH_ORIONSTEAM
	STEAM_CALLBACK_MANUAL(UOrionSteamUserStats, OnUserAchievementIconFetched, UserAchievementIconFetched_t, OnUserAchievementIconFetchedCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamUserStats, OnUserStatsReceived, UserStatsReceived_t, OnUserStatsReceivedCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamUserStats, OnUserStatsStored, UserStatsStored_t, OnUserStatsStoredCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamUserStats, OnUserAchievementStored, UserAchievementStored_t, OnUserAchievementStoredCallback);
	STEAM_CALLBACK_MANUAL(UOrionSteamUserStats, OnUserStatsUnloaded, UserStatsUnloaded_t, OnUserStatsUnloadedCallback);
#endif
};
