...
public:
	...
	FSteamLeaderboardEntry(const LeaderboardEntry_t& Data)
		: SteamID(Data.m_steamIDUser), GlobalRank(Data.m_nGlobalRank), Score(Data.m_nScore), Details(Data.m_cDetails), UGCHandle(Data.m_hUGC)
	{
	}
#endif
...
public:
	FUserAchievementIconFetched()
		: bAchieved(false), Icon(nullptr), m_nIconHandle(0)
	{
	}

#if WITH_ORIONSTEAM
	FUserAchievementIconFetched(const UserAchievementIconFetched_t& Data)
		: GameID(Data.m_nGameID), AchievementName(UTF8_TO_TCHAR(Data.m_rgchAchievementName)), bAchieved(Data.m_bAchieved), Icon(nullptr), m_nIconHandle(Data.m_nIconHandle)
	{
	}
#endif
...
public:
	FUserAchievementStored()
		: bGroupAchievement(false), CurrentProgress(0), MaxProgress(0)
	{
	}

#if WITH_ORIONSTEAM
	FUserAchievementStored(const UserAchievementStored_t& Data)
		: GameID(Data.m_nGameID), bGroupAchievement(Data.m_bGroupAchievement), AchievementName(UTF8_TO_TCHAR(Data.m_rgchAchievementName)), CurrentProgress(Data.m_nCurProgress), MaxProgress(Data.m_nMaxProgress)
	{
	}
#endif
...
public:
	...
	FUserStatsReceived(const UserStatsReceived_t& Data)
		: GameID(Data.m_nGameID), Result(_SteamResult(Data.m_eResult)), SteamID(Data.m_steamIDUser)
	{
	}
#endif
...
public:
	...
	FUserStatsStored(const UserStatsStored_t& Data)
		: GameID(Data.m_nGameID), Result(_SteamResult(Data.m_eResult))
	{
	}
#endif
...
public:
	...
	FLeaderboardScoresDownloaded(const LeaderboardScoresDownloaded_t& Data)
		: SteamLeaderboard(Data.m_hSteamLeaderboard), SteamLeaderboardEntries(Data.m_hSteamLeaderboardEntries), EntryCount(Data.m_cEntryCount)
	{
	}
#endif
...
public:
	...
	FRequestUserStatsData(const UserStatsReceived_t& Data)
		: GameID(Data.m_nGameID), Result(_SteamResult(Data.m_eResult)), SteamIDUser(Data.m_steamIDUser)
	{
	}
#endif
...
public:
	FLeaderboardScoreUploaded()
		: bSuccess(false), Score(0), bScoreChanged(false), GlobalRankNew(0), GlobalRankPrevious(0)
	{
	}

#if WITH_ORIONSTEAM
	FLeaderboardScoreUploaded(const LeaderboardScoreUploaded_t& Data)
		: bSuccess(Data.m_bSuccess > 0), SteamLeaderboard(Data.m_hSteamLeaderboard), Score(Data.m_nScore), bScoreChanged(Data.m_bScoreChanged > 0), GlobalRankNew(Data.m_nGlobalRankNew), GlobalRankPrevious(Data.m_nGlobalRankPrevious)
	{
	}
#endif
...
public:
	...
	FAttachLeaderboardUGCData(const LeaderboardUGCSet_t& Data)
		: SteamLeaderboard(Data.m_hSteamLeaderboard), Result(_SteamResult(Data.m_eResult))
	{
	}
#endif
...
public:
	...
	FLeaderboardFindResult(const LeaderboardFindResult_t& Data)
		: SteamLeaderboard(Data.m_hSteamLeaderboard), bLeaderboardFound(Data.m_bLeaderboardFound > 0)
	{
	}
#endif
...
public:
	FNumberOfCurrentPlayers()
		: bSuccess(false), Players(0)
	{
	}

#if WITH_ORIONSTEAM
	FNumberOfCurrentPlayers(const NumberOfCurrentPlayers_t& Data)
		: bSuccess(Data.m_bSuccess > 0), Players(Data.m_cPlayers)
	{
	}
#endif
