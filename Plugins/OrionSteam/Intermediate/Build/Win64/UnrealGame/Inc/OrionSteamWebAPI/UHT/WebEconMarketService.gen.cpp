...
ORIONSTEAMWEBAPI_API UClass* Z_Construct_UClass_UWebEconMarketService();
ORIONSTEAMWEBAPI_API UClass* Z_Construct_UClass_UWebEconMarketService_NoRegister();
...
struct Z_Construct_UFunction_UWebEconMarketService_CancelAppListingsForUser_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "OrionSteamWebAPI|EconMarketService" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWebEconMarketService_CancelAppListingsForUser_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UWebEconMarketService, nullptr, "CancelAppListingsForUser", Z_Construct_UFunction_UWebEconMarketService_CancelAppListingsForUser_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UWebEconMarketService_CancelAppListingsForUser_Statics::PropPointers), sizeof(Z_Construct_UFunction_UWebEconMarketService_CancelAppListingsForUser_Statics::WebEconMarketService_eventCancelAppListingsForUser_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWebEconMarketService_CancelAppListingsForUser_Statics::Function_MetaDataParams), Z_Construct_UFunction_UWebEconMarketService_CancelAppListingsForUser_Statics::Function_MetaDataParams)},  };
...
DEFINE_FUNCTION(UWebEconMarketService::execCancelAppListingsForUser)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->CancelAppListingsForUser(FOnOrionSteamWebAPICallback(Z_Param_Out_Callback),Z_Param_Key,Z_Param_AppId,Z_Param_SteamId,Z_Param_bSynchronous);
	P_NATIVE_END;
}
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWebEconMarketService_GetAssetID_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UWebEconMarketService, nullptr, "GetAssetID", Z_Construct_UFunction_UWebEconMarketService_GetAssetID_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UWebEconMarketService_GetAssetID_Statics::PropPointers), sizeof(Z_Construct_UFunction_UWebEconMarketService_GetAssetID_Statics::WebEconMarketService_eventGetAssetID_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWebEconMarketService_GetAssetID_Statics::Function_MetaDataParams), Z_Construct_UFunction_UWebEconMarketService_GetAssetID_Statics::Function_MetaDataParams)},  };
...
DEFINE_FUNCTION(UWebEconMarketService::execGetAssetID)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->GetAssetID(FOnOrionSteamWebAPICallback(Z_Param_Out_Callback),Z_Param_Key,Z_Param_AppId,Z_Param_ListingId);
	P_NATIVE_END;
}
...
const UECodeGen_Private::FDelegatePropertyParams Z_Construct_UFunction_UWebEconMarketService_GetMarketEligibility_Statics::NewProp_Callback = { "Callback", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Delegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(WebEconMarketService_eventGetMarketEligibility_Parms, Callback), Z_Construct_UDelegateFunction_OrionSteamWebAPI_OnOrionSteamWebAPICallback__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Callback_MetaData), NewProp_Callback_MetaData) }; // 2114134120
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWebEconMarketService_GetMarketEligibility_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UWebEconMarketService, nullptr, "GetMarketEligibility", Z_Construct_UFunction_UWebEconMarketService_GetMarketEligibility_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UWebEconMarketService_GetMarketEligibility_Statics::PropPointers), sizeof(Z_Construct_UFunction_UWebEconMarketService_GetMarketEligibility_Statics::WebEconMarketService_eventGetMarketEligibility_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWebEconMarketService_GetMarketEligibility_Statics::Function_MetaDataParams), Z_Construct_UFunction_UWebEconMarketService_GetMarketEligibility_Statics::Function_MetaDataParams)},  };
...
DEFINE_FUNCTION(UWebEconMarketService::execGetMarketEligibility)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->GetMarketEligibility(FOnOrionSteamWebAPICallback(Z_Param_Out_Callback),Z_Param_Key,Z_Param_SteamId);
	P_NATIVE_END;
}
...
const UECodeGen_Private::FDelegatePropertyParams Z_Construct_UFunction_UWebEconMarketService_GetPopular_Statics::NewProp_Callback = { "Callback", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Delegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(WebEconMarketService_eventGetPopular_Parms, Callback), Z_Construct_UDelegateFunction_OrionSteamWebAPI_OnOrionSteamWebAPICallback__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Callback_MetaData), NewProp_Callback_MetaData) }; // 2114134120
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWebEconMarketService_GetPopular_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UWebEconMarketService, nullptr, "GetPopular", Z_Construct_UFunction_UWebEconMarketService_GetPopular_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UWebEconMarketService_GetPopular_Statics::PropPointers), sizeof(Z_Construct_UFunction_UWebEconMarketService_GetPopular_Statics::WebEconMarketService_eventGetPopular_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWebEconMarketService_GetPopular_Statics::Function_MetaDataParams), Z_Construct_UFunction_UWebEconMarketService_GetPopular_Statics::Function_MetaDataParams)},  };
...
DEFINE_FUNCTION(UWebEconMarketService::execGetPopular)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->GetPopular(FOnOrionSteamWebAPICallback(Z_Param_Out_Callback),Z_Param_Key,Z_Param_Language,Z_Param_Rows,Z_Param_Start,Z_Param_FilterAppId,Z_Param_ECurrency);
	P_NATIVE_END;
}
...
struct Z_Construct_UClass_UWebEconMarketService_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UWebEconMarketService_CancelAppListingsForUser, "CancelAppListingsForUser" }, // 1745147147
		{ &Z_Construct_UFunction_UWebEconMarketService_GetAssetID, "GetAssetID" }, // 2023365656
		{ &Z_Construct_UFunction_UWebEconMarketService_GetMarketEligibility, "GetMarketEligibility" }, // 2539438113
		{ &Z_Construct_UFunction_UWebEconMarketService_GetPopular, "GetPopular" }, // 3503056561
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamWebAPI_Public_EconMarket_WebEconMarketService_h__Script_OrionSteamWebAPI_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UWebEconMarketService, UWebEconMarketService::StaticClass, TEXT("UWebEconMarketService"), &Z_Registration_Info_UClass_UWebEconMarketService, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebEconMarketService), 2436532209U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamWebAPI_Public_EconMarket_WebEconMarketService_h__Script_OrionSteamWebAPI_2193132040(TEXT("/Script/OrionSteamWebAPI"),
	Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamWebAPI_Public_EconMarket_WebEconMarketService_h__Script_OrionSteamWebAPI_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamWebAPI_Public_EconMarket_WebEconMarketService_h__Script_OrionSteamWebAPI_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
