...
ORIONSTEAMWEBAPI_API UEnum* Z_Construct_UEnum_OrionSteamWebAPI_EModifyItemPropertyType();
...
static UEnum* EModifyItemPropertyType_StaticEnum()
{
	...
	{
		Z_Registration_Info_UEnum_EModifyItemPropertyType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OrionSteamWebAPI_EModifyItemPropertyType, (UObject*)Z_Construct_UPackage__Script_OrionSteamWebAPI(), TEXT("EModifyItemPropertyType"));
	}
	return Z_Registration_Info_UEnum_EModifyItemPropertyType.OuterSingleton;
}
template<> ORIONSTEAMWEBAPI_API UEnum* StaticEnum<EModifyItemPropertyType>()
{
	return EModifyItemPropertyType_StaticEnum();
}
struct Z_Construct_UEnum_OrionSteamWebAPI_EModifyItemPropertyType_Statics
{
#if WITH_METADATA
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OrionSteamWebAPI_EModifyItemPropertyType_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_OrionSteamWebAPI,
	nullptr,
	"EModifyItemPropertyType",
	"EModifyItemPropertyType",
	Z_Construct_UEnum_OrionSteamWebAPI_EModifyItemPropertyType_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_OrionSteamWebAPI_EModifyItemPropertyType_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_OrionSteamWebAPI_EModifyItemPropertyType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_OrionSteamWebAPI_EModifyItemPropertyType_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_OrionSteamWebAPI_EModifyItemPropertyType()
{
	if (!Z_Registration_Info_UEnum_EModifyItemPropertyType.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EModifyItemPropertyType.InnerSingleton, Z_Construct_UEnum_OrionSteamWebAPI_EModifyItemPropertyType_Statics::EnumParams);
	}
...
class UScriptStruct* FModifyItemsItem::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FModifyItemsItem.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FModifyItemsItem, (UObject*)Z_Construct_UPackage__Script_OrionSteamWebAPI(), TEXT("ModifyItemsItem"));
	}
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FModifyItemsItem_Statics::NewProp_ModifyItemPropertyType = { "ModifyItemPropertyType", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FModifyItemsItem, ModifyItemPropertyType), Z_Construct_UEnum_OrionSteamWebAPI_EModifyItemPropertyType, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ModifyItemPropertyType_MetaData), NewProp_ModifyItemPropertyType_MetaData) }; // 3945297831
...
UScriptStruct* Z_Construct_UScriptStruct_FModifyItemsItem()
{
	...
	return Z_Registration_Info_UScriptStruct_FModifyItemsItem.InnerSingleton;
}
// ********** End ScriptStruct FModifyItemsItem ****************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamWebAPI_Public_InventoryService_WebInventoryServiceTypes_h__Script_OrionSteamWebAPI_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EModifyItemPropertyType_StaticEnum, TEXT("EModifyItemPropertyType"), &Z_Registration_Info_UEnum_EModifyItemPropertyType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3945297831U) },
	};
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FModifyItemsItem::StaticStruct, Z_Construct_UScriptStruct_FModifyItemsItem_Statics::NewStructOps, TEXT("ModifyItemsItem"), &Z_Registration_Info_UScriptStruct_FModifyItemsItem, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FModifyItemsItem), 4043433498U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamWebAPI_Public_InventoryService_WebInventoryServiceTypes_h__Script_OrionSteamWebAPI_225955871(TEXT("/Script/OrionSteamWebAPI"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamWebAPI_Public_InventoryService_WebInventoryServiceTypes_h__Script_OrionSteamWebAPI_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamWebAPI_Public_InventoryService_WebInventoryServiceTypes_h__Script_OrionSteamWebAPI_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamWebAPI_Public_InventoryService_WebInventoryServiceTypes_h__Script_OrionSteamWebAPI_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamWebAPI_Public_InventoryService_WebInventoryServiceTypes_h__Script_OrionSteamWebAPI_Statics::EnumInfo));
// ********** End Registration *********************************************************************
