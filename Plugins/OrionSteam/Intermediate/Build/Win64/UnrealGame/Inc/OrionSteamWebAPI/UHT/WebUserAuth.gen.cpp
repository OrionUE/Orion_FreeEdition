...
ORIONSTEAMWEBAPI_API UClass* Z_Construct_UClass_UWebUserAuth();
...
struct Z_Construct_UFunction_UWebUserAuth_AuthenticateUser_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "OrionSteamWebAPI|UserAuth" },
...
const UECodeGen_Private::FDelegatePropertyParams Z_Construct_UFunction_UWebUserAuth_AuthenticateUser_Statics::NewProp_Callback = { "Callback", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Delegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(WebUserAuth_eventAuthenticateUser_Parms, Callback), Z_Construct_UDelegateFunction_OrionSteamWebAPI_OnOrionSteamWebAPICallback__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Callback_MetaData), NewProp_Callback_MetaData) }; // 2114134120
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWebUserAuth_AuthenticateUser_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UWebUserAuth, nullptr, "AuthenticateUser", Z_Construct_UFunction_UWebUserAuth_AuthenticateUser_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UWebUserAuth_AuthenticateUser_Statics::PropPointers), sizeof(Z_Construct_UFunction_UWebUserAuth_AuthenticateUser_Statics::WebUserAuth_eventAuthenticateUser_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWebUserAuth_AuthenticateUser_Statics::Function_MetaDataParams), Z_Construct_UFunction_UWebUserAuth_AuthenticateUser_Statics::Function_MetaDataParams)},  };
...
DEFINE_FUNCTION(UWebUserAuth::execAuthenticateUser)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->AuthenticateUser(FOnOrionSteamWebAPICallback(Z_Param_Out_Callback),Z_Param_SteamId,Z_Param_SessionKey,Z_Param_EncryptedLoginKey);
	P_NATIVE_END;
}
...
const UECodeGen_Private::FDelegatePropertyParams Z_Construct_UFunction_UWebUserAuth_AuthenticateUserTicket_Statics::NewProp_Callback = { "Callback", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Delegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(WebUserAuth_eventAuthenticateUserTicket_Parms, Callback), Z_Construct_UDelegateFunction_OrionSteamWebAPI_OnOrionSteamWebAPICallback__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Callback_MetaData), NewProp_Callback_MetaData) }; // 2114134120
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWebUserAuth_AuthenticateUserTicket_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UWebUserAuth, nullptr, "AuthenticateUserTicket", Z_Construct_UFunction_UWebUserAuth_AuthenticateUserTicket_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UWebUserAuth_AuthenticateUserTicket_Statics::PropPointers), sizeof(Z_Construct_UFunction_UWebUserAuth_AuthenticateUserTicket_Statics::WebUserAuth_eventAuthenticateUserTicket_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWebUserAuth_AuthenticateUserTicket_Statics::Function_MetaDataParams), Z_Construct_UFunction_UWebUserAuth_AuthenticateUserTicket_Statics::Function_MetaDataParams)},  };
...
DEFINE_FUNCTION(UWebUserAuth::execAuthenticateUserTicket)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->AuthenticateUserTicket(FOnOrionSteamWebAPICallback(Z_Param_Out_Callback),Z_Param_Key,Z_Param_AppId,Z_Param_Ticket);
	P_NATIVE_END;
}
...
struct Z_Construct_UClass_UWebUserAuth_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UWebUserAuth_AuthenticateUser, "AuthenticateUser" }, // 216679726
		{ &Z_Construct_UFunction_UWebUserAuth_AuthenticateUserTicket, "AuthenticateUserTicket" }, // 3801498722
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamWebAPI_Public_SteamUserAuth_WebUserAuth_h__Script_OrionSteamWebAPI_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UWebUserAuth, UWebUserAuth::StaticClass, TEXT("UWebUserAuth"), &Z_Registration_Info_UClass_UWebUserAuth, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebUserAuth), 721546174U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamWebAPI_Public_SteamUserAuth_WebUserAuth_h__Script_OrionSteamWebAPI_2541733084(TEXT("/Script/OrionSteamWebAPI"),
	Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamWebAPI_Public_SteamUserAuth_WebUserAuth_h__Script_OrionSteamWebAPI_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamWebAPI_Public_SteamUserAuth_WebUserAuth_h__Script_OrionSteamWebAPI_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
