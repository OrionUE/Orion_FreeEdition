...
ORIONSTEAMSDKAPI_API UEnum* Z_Construct_UEnum_OrionSteamSDKAPI_ESteamBroadcastUploadResult();
...
ORIONSTEAMSDKAPI_API UScriptStruct* Z_Construct_UScriptStruct_FGetOPFSettingsResult();
ORIONSTEAMSDKAPI_API UScriptStruct* Z_Construct_UScriptStruct_FGetVideoURLResult();
...
static UEnum* ESteamBroadcastUploadResult_StaticEnum()
{
	...
	{
		Z_Registration_Info_UEnum_ESteamBroadcastUploadResult.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OrionSteamSDKAPI_ESteamBroadcastUploadResult, (UObject*)Z_Construct_UPackage__Script_OrionSteamSDKAPI(), TEXT("ESteamBroadcastUploadResult"));
	}
...
struct Z_Construct_UEnum_OrionSteamSDKAPI_ESteamBroadcastUploadResult_Statics
{
#if WITH_METADATA
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OrionSteamSDKAPI_ESteamBroadcastUploadResult_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_OrionSteamSDKAPI,
	nullptr,
	"ESteamBroadcastUploadResult",
	"ESteamBroadcastUploadResult",
	Z_Construct_UEnum_OrionSteamSDKAPI_ESteamBroadcastUploadResult_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_OrionSteamSDKAPI_ESteamBroadcastUploadResult_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_OrionSteamSDKAPI_ESteamBroadcastUploadResult_Statics::Enum_MetaDataParams), Z_Construct_UEnum_OrionSteamSDKAPI_ESteamBroadcastUploadResult_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_OrionSteamSDKAPI_ESteamBroadcastUploadResult()
{
	if (!Z_Registration_Info_UEnum_ESteamBroadcastUploadResult.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ESteamBroadcastUploadResult.InnerSingleton, Z_Construct_UEnum_OrionSteamSDKAPI_ESteamBroadcastUploadResult_Statics::EnumParams);
	}
...
class UScriptStruct* FGetOPFSettingsResult::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FGetOPFSettingsResult.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGetOPFSettingsResult, (UObject*)Z_Construct_UPackage__Script_OrionSteamSDKAPI(), TEXT("GetOPFSettingsResult"));
	}
...
UScriptStruct* Z_Construct_UScriptStruct_FGetOPFSettingsResult()
{
	...
	return Z_Registration_Info_UScriptStruct_FGetOPFSettingsResult.InnerSingleton;
}
...
class UScriptStruct* FGetVideoURLResult::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FGetVideoURLResult.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGetVideoURLResult, (UObject*)Z_Construct_UPackage__Script_OrionSteamSDKAPI(), TEXT("GetVideoURLResult"));
	}
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FGetVideoURLResult_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000020005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FGetVideoURLResult, Result), Z_Construct_UEnum_OrionSteamSDKAPI_ESteamResult, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Result_MetaData), NewProp_Result_MetaData) }; // 2505325344
...
UScriptStruct* Z_Construct_UScriptStruct_FGetVideoURLResult()
{
	...
	return Z_Registration_Info_UScriptStruct_FGetVideoURLResult.InnerSingleton;
}
// ********** End ScriptStruct FGetVideoURLResult **************************************************

// ********** Begin Delegate FOnGetOPFSettingsResult ***********************************************
struct Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetOPFSettingsResult__DelegateSignature_Statics
{
	struct _Script_OrionSteamSDKAPI_eventOnGetOPFSettingsResult_Parms
	{
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetOPFSettingsResult__DelegateSignature_Statics::NewProp_Data = { "Data", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_OrionSteamSDKAPI_eventOnGetOPFSettingsResult_Parms, Data), Z_Construct_UScriptStruct_FGetOPFSettingsResult, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Data_MetaData), NewProp_Data_MetaData) }; // 4004226527
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetOPFSettingsResult__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetOPFSettingsResult__DelegateSignature_Statics::NewProp_Data,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetOPFSettingsResult__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetOPFSettingsResult__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_OrionSteamSDKAPI, nullptr, "OnGetOPFSettingsResult__DelegateSignature", Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetOPFSettingsResult__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetOPFSettingsResult__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetOPFSettingsResult__DelegateSignature_Statics::_Script_OrionSteamSDKAPI_eventOnGetOPFSettingsResult_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00530000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetOPFSettingsResult__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetOPFSettingsResult__DelegateSignature_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetOPFSettingsResult__DelegateSignature_Statics::_Script_OrionSteamSDKAPI_eventOnGetOPFSettingsResult_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetOPFSettingsResult__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetOPFSettingsResult__DelegateSignature_Statics::FuncParams);
	}
...
void FOnGetOPFSettingsResult_DelegateWrapper(const FMulticastScriptDelegate& OnGetOPFSettingsResult, FGetOPFSettingsResult const& Data)
{
	...
	_Script_OrionSteamSDKAPI_eventOnGetOPFSettingsResult_Parms Parms;
	Parms.Data=Data;
...
struct Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetVideoURLResult__DelegateSignature_Statics
{
	struct _Script_OrionSteamSDKAPI_eventOnGetVideoURLResult_Parms
	{
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetVideoURLResult__DelegateSignature_Statics::NewProp_Data = { "Data", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_OrionSteamSDKAPI_eventOnGetVideoURLResult_Parms, Data), Z_Construct_UScriptStruct_FGetVideoURLResult, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Data_MetaData), NewProp_Data_MetaData) }; // 2611667837
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetVideoURLResult__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetVideoURLResult__DelegateSignature_Statics::NewProp_Data,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetVideoURLResult__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetVideoURLResult__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_OrionSteamSDKAPI, nullptr, "OnGetVideoURLResult__DelegateSignature", Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetVideoURLResult__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetVideoURLResult__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetVideoURLResult__DelegateSignature_Statics::_Script_OrionSteamSDKAPI_eventOnGetVideoURLResult_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00530000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetVideoURLResult__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetVideoURLResult__DelegateSignature_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetVideoURLResult__DelegateSignature_Statics::_Script_OrionSteamSDKAPI_eventOnGetVideoURLResult_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetVideoURLResult__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_OrionSteamSDKAPI_OnGetVideoURLResult__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
void FOnGetVideoURLResult_DelegateWrapper(const FMulticastScriptDelegate& OnGetVideoURLResult, FGetVideoURLResult const& Data)
{
	...
	_Script_OrionSteamSDKAPI_eventOnGetVideoURLResult_Parms Parms;
	Parms.Data=Data;
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamSDKAPI_Public_SteamVideo_SteamVideoTypes_h__Script_OrionSteamSDKAPI_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ ESteamBroadcastUploadResult_StaticEnum, TEXT("ESteamBroadcastUploadResult"), &Z_Registration_Info_UEnum_ESteamBroadcastUploadResult, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 355067741U) },
	};
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FGetOPFSettingsResult::StaticStruct, Z_Construct_UScriptStruct_FGetOPFSettingsResult_Statics::NewStructOps, TEXT("GetOPFSettingsResult"), &Z_Registration_Info_UScriptStruct_FGetOPFSettingsResult, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGetOPFSettingsResult), 4004226527U) },
		{ FGetVideoURLResult::StaticStruct, Z_Construct_UScriptStruct_FGetVideoURLResult_Statics::NewStructOps, TEXT("GetVideoURLResult"), &Z_Registration_Info_UScriptStruct_FGetVideoURLResult, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGetVideoURLResult), 2611667837U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamSDKAPI_Public_SteamVideo_SteamVideoTypes_h__Script_OrionSteamSDKAPI_2786426337(TEXT("/Script/OrionSteamSDKAPI"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamSDKAPI_Public_SteamVideo_SteamVideoTypes_h__Script_OrionSteamSDKAPI_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamSDKAPI_Public_SteamVideo_SteamVideoTypes_h__Script_OrionSteamSDKAPI_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamSDKAPI_Public_SteamVideo_SteamVideoTypes_h__Script_OrionSteamSDKAPI_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamSDKAPI_Public_SteamVideo_SteamVideoTypes_h__Script_OrionSteamSDKAPI_Statics::EnumInfo));
// ********** End Registration *********************************************************************
