...
ORIONSTEAMWEBAPI_API UClass* Z_Construct_UClass_UWebLobbyMatchmakingService();
...
struct Z_Construct_UFunction_UWebLobbyMatchmakingService_CreateLobby_Statics
{
	struct WebLobbyMatchmakingService_eventCreateLobby_Parms
	{
		...
		int32 AppId;
		int32 MaxMembers;
		EOrionSteamWebAPILobbyType LobbyType;
		FString LobbyName;
		FString InputJson;
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWebLobbyMatchmakingService_CreateLobby_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UWebLobbyMatchmakingService, nullptr, "CreateLobby", Z_Construct_UFunction_UWebLobbyMatchmakingService_CreateLobby_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UWebLobbyMatchmakingService_CreateLobby_Statics::PropPointers), sizeof(Z_Construct_UFunction_UWebLobbyMatchmakingService_CreateLobby_Statics::WebLobbyMatchmakingService_eventCreateLobby_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWebLobbyMatchmakingService_CreateLobby_Statics::Function_MetaDataParams), Z_Construct_UFunction_UWebLobbyMatchmakingService_CreateLobby_Statics::Function_MetaDataParams)},  };
...
DEFINE_FUNCTION(UWebLobbyMatchmakingService::execCreateLobby)
{
	...
	P_GET_ENUM(EOrionSteamWebAPILobbyType,Z_Param_LobbyType);
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->CreateLobby(FOnOrionSteamWebAPICallback(Z_Param_Out_Callback),Z_Param_Key,Z_Param_AppId,Z_Param_MaxMembers,EOrionSteamWebAPILobbyType(Z_Param_LobbyType),Z_Param_LobbyName,Z_Param_InputJson,Z_Param_SteamIdInvitedMembers,Z_Param_LobbyMetaData);
	P_NATIVE_END;
}
...
const UECodeGen_Private::FDelegatePropertyParams Z_Construct_UFunction_UWebLobbyMatchmakingService_RemoveUserFromLobby_Statics::NewProp_Callback = { "Callback", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Delegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(WebLobbyMatchmakingService_eventRemoveUserFromLobby_Parms, Callback), Z_Construct_UDelegateFunction_OrionSteamWebAPI_OnOrionSteamWebAPICallback__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Callback_MetaData), NewProp_Callback_MetaData) }; // 2114134120
...
DEFINE_FUNCTION(UWebLobbyMatchmakingService::execRemoveUserFromLobby)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->RemoveUserFromLobby(FOnOrionSteamWebAPICallback(Z_Param_Out_Callback),Z_Param_Key,Z_Param_AppId,Z_Param_SteamIdToRemove,Z_Param_SteamIdLobby,Z_Param_InputJson);
	P_NATIVE_END;
}
...
struct Z_Construct_UClass_UWebLobbyMatchmakingService_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UWebLobbyMatchmakingService_CreateLobby, "CreateLobby" }, // 1491035214
		{ &Z_Construct_UFunction_UWebLobbyMatchmakingService_RemoveUserFromLobby, "RemoveUserFromLobby" }, // 1086230613
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamWebAPI_Public_LobbyMatchmakingService_WebLobbyMatchmakingService_h__Script_OrionSteamWebAPI_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UWebLobbyMatchmakingService, UWebLobbyMatchmakingService::StaticClass, TEXT("UWebLobbyMatchmakingService"), &Z_Registration_Info_UClass_UWebLobbyMatchmakingService, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebLobbyMatchmakingService), 3748272665U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamWebAPI_Public_LobbyMatchmakingService_WebLobbyMatchmakingService_h__Script_OrionSteamWebAPI_2801162546(TEXT("/Script/OrionSteamWebAPI"),
	Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamWebAPI_Public_LobbyMatchmakingService_WebLobbyMatchmakingService_h__Script_OrionSteamWebAPI_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamWebAPI_Public_LobbyMatchmakingService_WebLobbyMatchmakingService_h__Script_OrionSteamWebAPI_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
