...
ORIONSTEAMWEBAPI_API UClass* Z_Construct_UClass_UWebLeaderboards();
...
const UECodeGen_Private::FDelegatePropertyParams Z_Construct_UFunction_UWebLeaderboards_DeleteLeaderboard_Statics::NewProp_Callback = { "Callback", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Delegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(WebLeaderboards_eventDeleteLeaderboard_Parms, Callback), Z_Construct_UDelegateFunction_OrionSteamWebAPI_OnOrionSteamWebAPICallback__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Callback_MetaData), NewProp_Callback_MetaData) }; // 2114134120
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWebLeaderboards_DeleteLeaderboard_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UWebLeaderboards, nullptr, "DeleteLeaderboard", Z_Construct_UFunction_UWebLeaderboards_DeleteLeaderboard_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UWebLeaderboards_DeleteLeaderboard_Statics::PropPointers), sizeof(Z_Construct_UFunction_UWebLeaderboards_DeleteLeaderboard_Statics::WebLeaderboards_eventDeleteLeaderboard_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWebLeaderboards_DeleteLeaderboard_Statics::Function_MetaDataParams), Z_Construct_UFunction_UWebLeaderboards_DeleteLeaderboard_Statics::Function_MetaDataParams)},  };
...
DEFINE_FUNCTION(UWebLeaderboards::execDeleteLeaderboard)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->DeleteLeaderboard(FOnOrionSteamWebAPICallback(Z_Param_Out_Callback),Z_Param_Key,Z_Param_AppId,Z_Param_Name);
	P_NATIVE_END;
}
...
const UECodeGen_Private::FDelegatePropertyParams Z_Construct_UFunction_UWebLeaderboards_FindOrCreateLeaderboard_Statics::NewProp_Callback = { "Callback", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Delegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(WebLeaderboards_eventFindOrCreateLeaderboard_Parms, Callback), Z_Construct_UDelegateFunction_OrionSteamWebAPI_OnOrionSteamWebAPICallback__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Callback_MetaData), NewProp_Callback_MetaData) }; // 2114134120
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWebLeaderboards_FindOrCreateLeaderboard_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UWebLeaderboards, nullptr, "FindOrCreateLeaderboard", Z_Construct_UFunction_UWebLeaderboards_FindOrCreateLeaderboard_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UWebLeaderboards_FindOrCreateLeaderboard_Statics::PropPointers), sizeof(Z_Construct_UFunction_UWebLeaderboards_FindOrCreateLeaderboard_Statics::WebLeaderboards_eventFindOrCreateLeaderboard_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWebLeaderboards_FindOrCreateLeaderboard_Statics::Function_MetaDataParams), Z_Construct_UFunction_UWebLeaderboards_FindOrCreateLeaderboard_Statics::Function_MetaDataParams)},  };
...
DEFINE_FUNCTION(UWebLeaderboards::execFindOrCreateLeaderboard)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->FindOrCreateLeaderboard(FOnOrionSteamWebAPICallback(Z_Param_Out_Callback),Z_Param_Key,Z_Param_AppId,Z_Param_Name,Z_Param_SortMethod,Z_Param_DisplayType,Z_Param_bCreateIfNotFound,Z_Param_bOnlyTrustedWrites,Z_Param_bOnlyFriendsReads);
	P_NATIVE_END;
}
...
const UECodeGen_Private::FDelegatePropertyParams Z_Construct_UFunction_UWebLeaderboards_GetLeaderboardEntries_Statics::NewProp_Callback = { "Callback", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Delegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(WebLeaderboards_eventGetLeaderboardEntries_Parms, Callback), Z_Construct_UDelegateFunction_OrionSteamWebAPI_OnOrionSteamWebAPICallback__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Callback_MetaData), NewProp_Callback_MetaData) }; // 2114134120
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWebLeaderboards_GetLeaderboardEntries_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UWebLeaderboards, nullptr, "GetLeaderboardEntries", Z_Construct_UFunction_UWebLeaderboards_GetLeaderboardEntries_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UWebLeaderboards_GetLeaderboardEntries_Statics::PropPointers), sizeof(Z_Construct_UFunction_UWebLeaderboards_GetLeaderboardEntries_Statics::WebLeaderboards_eventGetLeaderboardEntries_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWebLeaderboards_GetLeaderboardEntries_Statics::Function_MetaDataParams), Z_Construct_UFunction_UWebLeaderboards_GetLeaderboardEntries_Statics::Function_MetaDataParams)},  };
...
DEFINE_FUNCTION(UWebLeaderboards::execGetLeaderboardEntries)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->GetLeaderboardEntries(FOnOrionSteamWebAPICallback(Z_Param_Out_Callback),Z_Param_Key,Z_Param_AppId,Z_Param_RangeStart,Z_Param_RangeEnd,Z_Param_LeaderboardId,Z_Param_DataRequest,Z_Param_SteamId);
	P_NATIVE_END;
}
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWebLeaderboards_GetLeaderboardsForGame_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UWebLeaderboards, nullptr, "GetLeaderboardsForGame", Z_Construct_UFunction_UWebLeaderboards_GetLeaderboardsForGame_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UWebLeaderboards_GetLeaderboardsForGame_Statics::PropPointers), sizeof(Z_Construct_UFunction_UWebLeaderboards_GetLeaderboardsForGame_Statics::WebLeaderboards_eventGetLeaderboardsForGame_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWebLeaderboards_GetLeaderboardsForGame_Statics::Function_MetaDataParams), Z_Construct_UFunction_UWebLeaderboards_GetLeaderboardsForGame_Statics::Function_MetaDataParams)},  };
...
DEFINE_FUNCTION(UWebLeaderboards::execGetLeaderboardsForGame)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->GetLeaderboardsForGame(FOnOrionSteamWebAPICallback(Z_Param_Out_Callback),Z_Param_Key,Z_Param_AppId);
	P_NATIVE_END;
}
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWebLeaderboards_ResetLeaderboard_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UWebLeaderboards, nullptr, "ResetLeaderboard", Z_Construct_UFunction_UWebLeaderboards_ResetLeaderboard_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UWebLeaderboards_ResetLeaderboard_Statics::PropPointers), sizeof(Z_Construct_UFunction_UWebLeaderboards_ResetLeaderboard_Statics::WebLeaderboards_eventResetLeaderboard_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWebLeaderboards_ResetLeaderboard_Statics::Function_MetaDataParams), Z_Construct_UFunction_UWebLeaderboards_ResetLeaderboard_Statics::Function_MetaDataParams)},  };
...
DEFINE_FUNCTION(UWebLeaderboards::execResetLeaderboard)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->ResetLeaderboard(FOnOrionSteamWebAPICallback(Z_Param_Out_Callback),Z_Param_Key,Z_Param_AppId,Z_Param_LeaderboardId);
	P_NATIVE_END;
}
...
DEFINE_FUNCTION(UWebLeaderboards::execSetLeaderboardScore)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->SetLeaderboardScore(FOnOrionSteamWebAPICallback(Z_Param_Out_Callback),Z_Param_Key,Z_Param_AppId,Z_Param_LeaderbordId,Z_Param_SteamId,Z_Param_Score,Z_Param_Details,Z_Param_ScoreMethod);
	P_NATIVE_END;
}
...
struct Z_Construct_UClass_UWebLeaderboards_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UWebLeaderboards_DeleteLeaderboard, "DeleteLeaderboard" }, // 1194069200
		{ &Z_Construct_UFunction_UWebLeaderboards_FindOrCreateLeaderboard, "FindOrCreateLeaderboard" }, // 2261506871
		{ &Z_Construct_UFunction_UWebLeaderboards_GetLeaderboardEntries, "GetLeaderboardEntries" }, // 381740512
		{ &Z_Construct_UFunction_UWebLeaderboards_GetLeaderboardsForGame, "GetLeaderboardsForGame" }, // 269249238
		{ &Z_Construct_UFunction_UWebLeaderboards_ResetLeaderboard, "ResetLeaderboard" }, // 2145262747
		{ &Z_Construct_UFunction_UWebLeaderboards_SetLeaderboardScore, "SetLeaderboardScore" }, // 3772457627
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamWebAPI_Public_Leaderboards_WebLeaderboards_h__Script_OrionSteamWebAPI_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UWebLeaderboards, UWebLeaderboards::StaticClass, TEXT("UWebLeaderboards"), &Z_Registration_Info_UClass_UWebLeaderboards, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebLeaderboards), 1444762518U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamWebAPI_Public_Leaderboards_WebLeaderboards_h__Script_OrionSteamWebAPI_541106005(TEXT("/Script/OrionSteamWebAPI"),
	Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamWebAPI_Public_Leaderboards_WebLeaderboards_h__Script_OrionSteamWebAPI_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamWebAPI_Public_Leaderboards_WebLeaderboards_h__Script_OrionSteamWebAPI_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
