...
#ifdef ORIONSTEAMSDKAPI_SteamUtilsTypes_generated_h
...
#define FOREACH_ENUM_EORIONSTEAMIPV6CONNECTIVITYPROTOCOL(op) \
	op(EOrionSteamIPv6ConnectivityProtocol::k_ESteamIPv6ConnectivityProtocol_Invalid) \
	op(EOrionSteamIPv6ConnectivityProtocol::k_ESteamIPv6ConnectivityProtocol_HTTP) \
	op(EOrionSteamIPv6ConnectivityProtocol::k_ESteamIPv6ConnectivityProtocol_UDP) 
...
#define FOREACH_ENUM_EORIONSTEAMIPV6CONNECTIVITYSTATE(op) \
	op(EOrionSteamIPv6ConnectivityState::k_ESteamIPv6ConnectivityState_Unknown) \
	op(EOrionSteamIPv6ConnectivityState::k_ESteamIPv6ConnectivityState_Good) \
	op(EOrionSteamIPv6ConnectivityState::k_ESteamIPv6ConnectivityState_Bad) 
