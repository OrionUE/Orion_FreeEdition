...
// IWYU pragma: private, include "OrionSteamSDKAPI/SteamTypes.h"

#ifdef ORIONSTEAMSDKAPI_SteamTypes_generated_h
...
#define CURRENT_FILE_ID FID_Orion_FreeEdition_Plugins_OrionSteam_Source_OrionSteamSDKAPI_Public_OrionSteamSDKAPI_SteamTypes_h
...
#define FOREACH_ENUM_EORIONSTEAMNETWORKINGIDENTITYTYPE(op) \
	op(EOrionSteamNetworkingIdentityType::k_ESteamNetworkingIdentityType_Invalid) \
	op(EOrionSteamNetworkingIdentityType::k_ESteamNetworkingIdentityType_SteamID) \
	op(EOrionSteamNetworkingIdentityType::k_ESteamNetworkingIdentityType_XboxPairwiseID) \
	op(EOrionSteamNetworkingIdentityType::k_ESteamNetworkingIdentityType_SonyPSN) \
	op(EOrionSteamNetworkingIdentityType::k_ESteamNetworkingIdentityType_GoogleStadia) \
	op(EOrionSteamNetworkingIdentityType::k_ESteamNetworkingIdentityType_IPAddress) \
	op(EOrionSteamNetworkingIdentityType::k_ESteamNetworkingIdentityType_GenericString) \
	op(EOrionSteamNetworkingIdentityType::k_ESteamNetworkingIdentityType_GenericBytes) \
	op(EOrionSteamNetworkingIdentityType::k_ESteamNetworkingIdentityType_UnknownType) \
	op(EOrionSteamNetworkingIdentityType::k_ESteamNetworkingIdentityType__Force32bit) 
