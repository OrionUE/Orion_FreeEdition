...
public:
	...
	SLATE_BEGIN_ARGS(SOrionBrowser)
	...
	{ }
		...
		/** Whether we should use a workaround for CEF bugs. */
		SLATE_ARGUMENT(bool, UseSmoothResizing);
	...
	/** Default constructor. */
	ORIONBROWSER_API SOrionBrowser();
	...
	*/
	...
	/** Sets whether web content may change the Slate/platform mouse cursor. */
	ORIONBROWSER_API void SetCursorPolicy(EOrionBrowserCursorPolicy InCursorPolicy);

	/** Gets whether web content may change the Slate/platform mouse cursor. */
	ORIONBROWSER_API EOrionBrowserCursorPolicy GetCursorPolicy() const;

	/** Show the throbber and hide the web browser content. */
	ORIONBROWSER_API void ShowThrobber();

	/** Hide the throbber and show the web browser content. */
	ORIONBROWSER_API void HideThrobber();

private:

	/** Navigate backwards. */
	ORIONBROWSER_API FReply OnBackClicked();

	/** Navigate forwards. */
	ORIONBROWSER_API FReply OnForwardClicked();

	/** Get text for reload button depending on status */
	ORIONBROWSER_API FText GetReloadButtonText() const;

	/** Reload or stop loading */
	ORIONBROWSER_API FReply OnReloadClicked();

	/** Invoked whenever text is committed in the address bar. */
	ORIONBROWSER_API void OnUrlTextCommitted( const FText& NewText, ETextCommit::Type CommitType );

	/** Get whether the page viewport should be visible */
	ORIONBROWSER_API EVisibility GetViewportVisibility() const;

	/** Get whether loading throbber should be visible */
	ORIONBROWSER_API EVisibility GetLoadingThrobberVisibility() const;

private:

	/** The actual web browser view */
	TSharedPtr<SOrionBrowserView> BrowserView;
	...
	/** Whether to force the throbber to appear */
	bool bForceThrobber = false;

	/** The WebBrowserWindow itself. */
	TSharedPtr<IWebBrowserWindow> WebBrowserWindow;

	/** Pre-shutdown delegate handle, to unbind the Input Method System. */
