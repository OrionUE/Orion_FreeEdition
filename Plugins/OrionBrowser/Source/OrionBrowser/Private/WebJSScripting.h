...
{
public:
	FOrionWebJSScripting(bool bInJSBindingToLoweringEnabled)
	...
	virtual void InvokeJSFunction(FGuid FunctionId, int32 ArgCount, FOrionWebJSParam Arguments[], bool bIsError=false) =0;
	virtual void InvokeJSErrorResult(FGuid FunctionId, const FString& Error) =0;

	FString GetBindingName(const FString& Name, UObject* Object) const { return bJSBindingToLoweringEnabled ? Name.ToLower() : Name; }

	FString GetBindingName(const FFieldVariant& Property) const { return bJSBindingToLoweringEnabled ? Property.GetName().ToLower() : Property.GetName(); }
...
public:
	...
	virtual FString GetReferencerName() const override { return TEXT("FOrionWebJSScripting"); }
