...
class FOrionCEFWebBrowserDialog
	: public IWebBrowserDialog
{
public:
	virtual ~FOrionCEFWebBrowserDialog() = default;

	// IWebBrowserDialog interface:

	virtual EWebBrowserDialogType GetType() override { return Type; }

	virtual const FText& GetMessageText() override { return MessageText; }

	virtual const FText& GetDefaultPrompt() override { return DefaultPrompt; }
...
private:
	...
	FOrionCEFWebBrowserDialog(CefJSDialogHandler::JSDialogType InDialogType, const CefString& InMessageText, const CefString& InDefaultPrompt, CefRefPtr<CefJSDialogCallback> InCallback)
	...
	FOrionCEFWebBrowserDialog(const CefString& InMessageText, bool InIsReload, CefRefPtr<CefJSDialogCallback> InCallback)
	...
	friend class FOrionCEFWebBrowserWindow;
};

typedef FOrionCEFWebBrowserDialog FWebBrowserDialog;
