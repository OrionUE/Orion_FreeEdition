...
class FOrionCEFBrowserPopupFeatures;
...
public:
	...
	/** Default constructor. */
	FOrionCEFBrowserHandler(bool InUseTransparency, bool InInterceptLoadRequests, const TArray<FString>& AltRetryDomains = TArray<FString>(), const TArray<FString>& AuthorizationHeaderAllowListURLS = TArray<FString>());
	 ...
	 */
	void SetBrowserWindow(TSharedPtr<FOrionCEFWebBrowserWindow> InBrowserWindow);
	 ...
	 */
	void SetPopupFeatures(const TSharedPtr<FOrionCEFBrowserPopupFeatures>& InPopupFeatures)
	{
	...
	virtual void OnLoadError(CefRefPtr<CefBrowser> Browser, CefRefPtr<CefFrame> Frame, CefLoadHandler::ErrorCode InErrorCode, const CefString& ErrorText, const CefString& FailedUrl) override;
	virtual void OnLoadingStateChange(CefRefPtr<CefBrowser> browser, bool isLoading, bool canGoBack, bool canGoForward) override;
	virtual void OnLoadStart(CefRefPtr<CefBrowser> Browser, CefRefPtr<CefFrame> Frame, TransitionType CefTransitionType) override;

	// CefRenderHandler Interface
	virtual bool GetRootScreenRect(CefRefPtr<CefBrowser> Browser, CefRect& Rect) override;
	virtual void GetViewRect(CefRefPtr<CefBrowser> Browser, CefRect& Rect) override;
	virtual void OnPaint(CefRefPtr<CefBrowser> Browser, PaintElementType Type, const RectList& DirtyRects, const void* Buffer, int Width, int Height) override;
	virtual void OnAcceleratedPaint(CefRefPtr<CefBrowser> Browser, PaintElementType Type, const RectList& DirtyRects, const CefAcceleratedPaintInfo& SharedHandle) override;
...
#if !PLATFORM_LINUX
	virtual void OnImeCompositionRangeChanged(CefRefPtr<CefBrowser> Browser, const CefRange& SelectionRange, const CefRenderHandler::RectList& CharacterBounds) override;
	virtual void OnTextSelectionChanged(CefRefPtr<CefBrowser> Browser, const CefString& SelectedText, const CefRange& SelectionRange) override;
#endif
	...
	virtual void OnResourceLoadComplete(CefRefPtr<CefBrowser> Browser, CefRefPtr<CefFrame> Frame, CefRefPtr<CefRequest> Request, CefRefPtr<CefResponse> Response, URLRequestStatus Status, int64_t Received_content_length) override;
	...
	virtual bool OnBeforeBrowse(CefRefPtr<CefBrowser> Browser, CefRefPtr<CefFrame> Frame, CefRefPtr<CefRequest> Request, bool user_gesture, bool IsRedirect) override;
	...
	virtual bool OnCertificateError(CefRefPtr<CefBrowser> Browser, cef_errorcode_t CertError, const CefString& RequestUrl, CefRefPtr<CefSSLInfo> SslInfo, CefRefPtr<CefCallback> Callback) override;
	...
	virtual bool OnJSDialog(CefRefPtr<CefBrowser> Browser, const CefString& OriginUrl, JSDialogType DialogType, const CefString& MessageText, const CefString& DefaultPromptText, CefRefPtr<CefJSDialogCallback> Callback, bool& OutSuppressMessage) override;
	...
	virtual bool OnFileDialog(CefRefPtr<CefBrowser> Browser, FileDialogMode Mode, const CefString& Title, const CefString& DefaultFilePath, const std::vector<CefString>& AcceptFilters, const std::vector<CefString>& AcceptExtensions, const std::vector<CefString>& AcceptDescriptions, CefRefPtr<CefFileDialogCallback> Callback) override;


	IWebBrowserWindow::FOnBeforePopupDelegate& OnBeforePopup() { return BeforePopupDelegate; }

	IWebBrowserWindow::FOnCreateWindow& OnCreateWindow() { return CreateWindowDelegate; }
	...
	FOnBeforeResourceLoadDelegate& OnBeforeResourceLoad() { return BeforeResourceLoadDelegate; }
	...
	FOnResourceLoadCompleteDelegate& OnResourceLoadComplete() { return ResourceLoadCompleteDelegate; }
	...
	FOnConsoleMessageDelegate& OnConsoleMessage() { return ConsoleMessageDelegate; }
...
private:
	...
	TWeakPtr<FOrionCEFWebBrowserWindow> BrowserWindowPtr;
	
	/** Pointer to the parent web browser handler */
	CefRefPtr<FOrionCEFBrowserHandler> ParentHandler;

	/** Stores popup window features and settings */
	TSharedPtr<FOrionCEFBrowserPopupFeatures> BrowserPopupFeatures;

	// Include the default reference counting implementation.
	IMPLEMENT_REFCOUNTING(FOrionCEFBrowserHandler);
};
