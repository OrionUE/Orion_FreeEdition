...
void LogCEFLoad(const FString &Msg, CefRefPtr<CefRequest> Request)
{
	...
	{
		GLog->Logf(ELogVerbosity::Display, TEXT("%s :%s type:%s"), *Msg, url.c_str(), *OrionResourceTypeToString(type));
	}
}
...
const FString CustomContentMethod("X-GET-CUSTOM-CONTENT");

FOrionCEFBrowserHandler::FOrionCEFBrowserHandler(bool InUseTransparency, bool InInterceptLoadRequests, const TArray<FString>& InAltRetryDomains, const TArray<FString>& InAuthorizationHeaderAllowListURLS)
...
void FOrionCEFBrowserHandler::OnTitleChange(CefRefPtr<CefBrowser> Browser, const CefString& Title)
{
	TSharedPtr<FOrionCEFWebBrowserWindow> BrowserWindow = BrowserWindowPtr.Pin();
...
void FOrionCEFBrowserHandler::OnAddressChange(CefRefPtr<CefBrowser> Browser, CefRefPtr<CefFrame> Frame, const CefString& Url)
{
	if (Frame->IsMain())
	{
		TSharedPtr<FOrionCEFWebBrowserWindow> BrowserWindow = BrowserWindowPtr.Pin();
...
bool FOrionCEFBrowserHandler::OnTooltip(CefRefPtr<CefBrowser> Browser, CefString& Text)
{
	TSharedPtr<FOrionCEFWebBrowserWindow> BrowserWindow = BrowserWindowPtr.Pin();
	if (BrowserWindow.IsValid())
	{
...
bool FOrionCEFBrowserHandler::OnConsoleMessage(CefRefPtr<CefBrowser> Browser, cef_log_severity_t level, const CefString& Message, const CefString& Source, int Line)
{
...
void FOrionCEFBrowserHandler::OnAfterCreated(CefRefPtr<CefBrowser> Browser)
{
	if (Browser->IsPopup())
	{
		TSharedPtr<FOrionCEFWebBrowserWindow> BrowserWindowParent = ParentHandler.get() ? ParentHandler->BrowserWindowPtr.Pin() : nullptr;
		if (BrowserWindowParent.IsValid() && ParentHandler->OnCreateWindow().IsBound())
		{
			...
			TSharedPtr<IWebBrowserWindow> NewBrowserWindow = IOrionBrowserModule::Get().GetSingleton()->CreateBrowserWindow(
				BrowserWindowParent,
...

			{
				...
				TSharedPtr<FOrionCEFWebBrowserWindow> HandlerSpecificBrowserWindow = StaticCastSharedPtr<FOrionCEFWebBrowserWindow>(NewBrowserWindow);
...
bool FOrionCEFBrowserHandler::DoClose(CefRefPtr<CefBrowser> Browser)
{
	TSharedPtr<FOrionCEFWebBrowserWindow> BrowserWindow = BrowserWindowPtr.Pin();
	if (BrowserWindow.IsValid())
	{
...
void FOrionCEFBrowserHandler::OnBeforeClose(CefRefPtr<CefBrowser> Browser)
{
	TSharedPtr<FOrionCEFWebBrowserWindow> BrowserWindow = BrowserWindowPtr.Pin();
	if (BrowserWindow.IsValid())
	{
...
bool FOrionCEFBrowserHandler::OnBeforePopup(CefRefPtr<CefBrowser> Browser, CefRefPtr<CefFrame> Frame, const CefString& TargetUrl, const CefString& TargetFrameName, const CefPopupFeatures& PopupFeatures, CefWindowInfo& OutWindowInfo, CefRefPtr<CefClient>& OutClient, CefBrowserSettings& OutSettings, bool* OutNoJavascriptAccess)
{
	...
	{
		TSharedPtr<FOrionCEFBrowserPopupFeatures> NewBrowserPopupFeatures = MakeShareable(new FOrionCEFBrowserPopupFeatures(PopupFeatures));
		...
		CefRefPtr<FOrionCEFBrowserHandler> NewHandler(new FOrionCEFBrowserHandler(shouldUseTransparency, true /*InterceptLoadRequests*/));
...
bool FOrionCEFBrowserHandler::OnCertificateError(CefRefPtr<CefBrowser> Browser, cef_errorcode_t CertError, const CefString &RequestUrl, CefRefPtr<CefSSLInfo> SslInfo, CefRefPtr<CefCallback> Callback)
{
...
void FOrionCEFBrowserHandler::OnLoadError(CefRefPtr<CefBrowser> Browser, CefRefPtr<CefFrame> Frame, CefLoadHandler::ErrorCode InErrorCode, const CefString& ErrorText, const CefString& FailedUrl)
{
...
void FOrionCEFBrowserHandler::OnLoadStart(CefRefPtr<CefBrowser> Browser, CefRefPtr<CefFrame> Frame, TransitionType CefTransitionType)
{
}

void FOrionCEFBrowserHandler::OnLoadingStateChange(CefRefPtr<CefBrowser> Browser, bool bIsLoading, bool bCanGoBack, bool bCanGoForward)
{
	TSharedPtr<FOrionCEFWebBrowserWindow> BrowserWindow = BrowserWindowPtr.Pin();
...
bool FOrionCEFBrowserHandler::GetRootScreenRect(CefRefPtr<CefBrowser> Browser, CefRect& Rect)
{
	if (CefCurrentlyOn(TID_UI) && FSlateApplication::IsInitialized())
	{
...
void FOrionCEFBrowserHandler::GetViewRect(CefRefPtr<CefBrowser> Browser, CefRect& Rect)
{
	TSharedPtr<FOrionCEFWebBrowserWindow> BrowserWindow = BrowserWindowPtr.Pin();
...
void FOrionCEFBrowserHandler::OnPaint(CefRefPtr<CefBrowser> Browser, PaintElementType Type, const RectList& DirtyRects, const void* Buffer, int Width, int Height)
{
	TSharedPtr<FOrionCEFWebBrowserWindow> BrowserWindow = BrowserWindowPtr.Pin();
...
void FOrionCEFBrowserHandler::OnAcceleratedPaint(CefRefPtr<CefBrowser> Browser, PaintElementType Type, const RectList& DirtyRects, const CefAcceleratedPaintInfo& SharedHandle)
{
	TSharedPtr<FOrionCEFWebBrowserWindow> BrowserWindow = BrowserWindowPtr.Pin();
...
bool FOrionCEFBrowserHandler::OnCursorChange(CefRefPtr<CefBrowser> Browser, CefCursorHandle Cursor, cef_cursor_type_t Type, const CefCursorInfo& CustomCursorInfo)
{
	TSharedPtr<FOrionCEFWebBrowserWindow> BrowserWindow = BrowserWindowPtr.Pin();
...
void FOrionCEFBrowserHandler::OnPopupShow(CefRefPtr<CefBrowser> Browser, bool bShow)
{
	TSharedPtr<FOrionCEFWebBrowserWindow> BrowserWindow = BrowserWindowPtr.Pin();
...
void FOrionCEFBrowserHandler::OnPopupSize(CefRefPtr<CefBrowser> Browser, const CefRect& Rect)
{
	TSharedPtr<FOrionCEFWebBrowserWindow> BrowserWindow = BrowserWindowPtr.Pin();
...
bool FOrionCEFBrowserHandler::GetScreenInfo(CefRefPtr<CefBrowser> Browser, CefScreenInfo& ScreenInfo)
{
...
#if !PLATFORM_LINUX
void FOrionCEFBrowserHandler::OnImeCompositionRangeChanged(CefRefPtr<CefBrowser> Browser, const CefRange& SelectionRange, const CefRenderHandler::RectList& CharacterBounds)
{
	TSharedPtr<FOrionCEFWebBrowserWindow> BrowserWindow = BrowserWindowPtr.Pin();
	if (BrowserWindow.IsValid())
	{
...
void FOrionCEFBrowserHandler::OnTextSelectionChanged(CefRefPtr<CefBrowser> Browser, const CefString& SelectedText, const CefRange& SelectionRange)
{
	TSharedPtr<FOrionCEFWebBrowserWindow> BrowserWindow = BrowserWindowPtr.Pin();
	if (BrowserWindow.IsValid())
	{
		BrowserWindow->OnTextSelectionChanged(Browser, SelectedText, SelectionRange);
	}
}
#endif


CefResourceRequestHandler::ReturnValue FOrionCEFBrowserHandler::OnBeforeResourceLoad(CefRefPtr<CefBrowser> Browser, CefRefPtr<CefFrame> Frame, CefRefPtr<CefRequest> Request, CefRefPtr<CefCallback> Callback)
{
	if (Request->IsReadOnly())
	{
		LOG_CEF_LOAD("FOrionCEFBrowserHandler::OnBeforeResourceLoad - readonly");
	...
	CefPostTask(TID_UI, new FOrionCEFBrowserClosureTask(this, [=, this]()
	{
		...
		LOG_CEF_LOAD("FOrionCEFBrowserHandler::OnBeforeResourceLoad");
...
void FOrionCEFBrowserHandler::OnResourceLoadComplete(CefRefPtr<CefBrowser> Browser, CefRefPtr<CefFrame> Frame, CefRefPtr<CefRequest> Request, CefRefPtr<CefResponse> Response, URLRequestStatus Status, int64_t Received_content_length)
{
	LOG_CEF_LOAD("FOrionCEFBrowserHandler::OnResourceLoadComplete");
...
void FOrionCEFBrowserHandler::OnResourceRedirect(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> Frame, CefRefPtr<CefRequest> Request, CefRefPtr<CefResponse> Response, CefString& new_url)
{
	LOG_CEF_LOAD("FOrionCEFBrowserHandler::OnResourceRedirect");
	// Current thread is IO thread. We need to invoke our delegates on the UI (aka Game) thread:
	CefPostTask(TID_UI, new FOrionCEFBrowserClosureTask(this, [=, this]()
	{
...
void FOrionCEFBrowserHandler::OnRenderProcessTerminated(CefRefPtr<CefBrowser> Browser, TerminationStatus Status, int error_code, const CefString& error_string)
{
	TSharedPtr<FOrionCEFWebBrowserWindow> BrowserWindow = BrowserWindowPtr.Pin();
	if (BrowserWindow.IsValid())
	{
...
bool FOrionCEFBrowserHandler::OnBeforeBrowse(CefRefPtr<CefBrowser> Browser, CefRefPtr<CefFrame> Frame, CefRefPtr<CefRequest> Request, bool user_gesture, bool IsRedirect)
{
	...
	if (BrowserWindow.IsValid())
	{
		LOG_CEF_LOAD("FOrionCEFBrowserHandler::OnBeforeBrowse");
...
CefRefPtr<CefResourceHandler> FOrionCEFBrowserHandler::GetResourceHandler(CefRefPtr<CefBrowser> Browser, CefRefPtr<CefFrame> Frame, CefRefPtr<CefRequest> Request)
{
	...
	if (Request->GetMethod() == TCHAR_TO_WCHAR(*CustomContentMethod))
	{
		...
		if (Request->GetPostData() && Request->GetPostData()->GetElementCount() > 0)
		{
			...
			FString MimeType = "text/html"; // default if not specified
			CefRequest::HeaderMap HeaderMap;
			Request->GetHeaderMap(HeaderMap);
			...
			return new FOrionCEFBrowserByteResource(Elements[0], MimeType);
		}
	}
	return nullptr;
}

CefRefPtr<CefResourceRequestHandler> FOrionCEFBrowserHandler::GetResourceRequestHandler(CefRefPtr<CefBrowser> Browser, CefRefPtr<CefFrame> Frame, CefRefPtr<CefRequest> Request, bool is_navigation, bool is_download, const CefString& request_initiator, bool& disable_default_handling)
{
	LOG_CEF_LOAD("FOrionCEFBrowserHandler::GetResourceRequestHandler");
...
void FOrionCEFBrowserHandler::SetBrowserWindow(TSharedPtr<FOrionCEFWebBrowserWindow> InBrowserWindow)
{
...
bool FOrionCEFBrowserHandler::OnProcessMessageReceived(CefRefPtr<CefBrowser> Browser, CefRefPtr<CefFrame> Frame, CefProcessId SourceProcess, CefRefPtr<CefProcessMessage> Message)
{
	if (IOrionBrowserModule::Get().GetSingleton()->IsShuttingDown())
	{
		UE_LOGF(LogOrionBrowser, Warning, "Received a process message while the module is shutting down, ignoring.");
		return false;
	}
	...
	if (BrowserWindow.IsValid())
	{
		if (MessageName.StartsWith(TEXT("CEF::BROWSERCREATED")))
		{
			...
			CefPostTask(TID_UI, new FOrionCEFBrowserClosureTask(this, [=]()
				{
...
bool FOrionCEFBrowserHandler::ShowDevTools(const CefRefPtr<CefBrowser>& Browser)
{
	CefPoint Point;
	...
	BrowserSettings.windowless_frame_rate = OrionBrowserConfig::ResolveBrowserFrameRate(OrionBrowserConfig::UnrestrictedFrameRate);
...
bool FOrionCEFBrowserHandler::OnKeyEvent(CefRefPtr<CefBrowser> Browser, const CefKeyEvent& Event, CefEventHandle OsEvent)
{
	...
	if ( (Event.type == KEYEVENT_RAWKEYDOWN || Event.type == KEYEVENT_KEYDOWN || Event.type == KEYEVENT_CHAR) &&
		...
		IOrionBrowserModule::Get().GetSingleton()->IsDevToolsShortcutEnabled()
	  )
	{
...
bool FOrionCEFBrowserHandler::OnJSDialog(CefRefPtr<CefBrowser> Browser, const CefString& OriginUrl, JSDialogType DialogType, const CefString& MessageText, const CefString& DefaultPromptText, CefRefPtr<CefJSDialogCallback> Callback, bool& OutSuppressMessage)
{
	bool Retval = false;
	TSharedPtr<FOrionCEFWebBrowserWindow> BrowserWindow = BrowserWindowPtr.Pin();
	if (BrowserWindow.IsValid())
...
bool FOrionCEFBrowserHandler::OnBeforeUnloadDialog(CefRefPtr<CefBrowser> Browser, const CefString& MessageText, bool IsReload, CefRefPtr<CefJSDialogCallback> Callback)
{
	bool Retval = false;
	TSharedPtr<FOrionCEFWebBrowserWindow> BrowserWindow = BrowserWindowPtr.Pin();
	if (BrowserWindow.IsValid())
...
void FOrionCEFBrowserHandler::OnResetDialogState(CefRefPtr<CefBrowser> Browser)
{
	TSharedPtr<FOrionCEFWebBrowserWindow> BrowserWindow = BrowserWindowPtr.Pin();
	if (BrowserWindow.IsValid())
	{
...
void FOrionCEFBrowserHandler::OnBeforeContextMenu(CefRefPtr<CefBrowser> Browser, CefRefPtr<CefFrame> Frame, CefRefPtr<CefContextMenuParams> Params, CefRefPtr<CefMenuModel> Model)
{
	TSharedPtr<FOrionCEFWebBrowserWindow> BrowserWindow = BrowserWindowPtr.Pin();
...
void FOrionCEFBrowserHandler::OnDraggableRegionsChanged(CefRefPtr<CefBrowser> Browser, CefRefPtr<CefFrame> frame, const std::vector<CefDraggableRegion>& Regions)
{
	TSharedPtr<FOrionCEFWebBrowserWindow> BrowserWindow = BrowserWindowPtr.Pin();
	if (BrowserWindow.IsValid())
	{
...
bool FOrionCEFBrowserHandler::OnFileDialog(CefRefPtr<CefBrowser> Browser, FileDialogMode Mode, const CefString& Title, const CefString& DefaultFilePath, const std::vector<CefString>& AcceptFilters, const std::vector<CefString>& AcceptExtensions, const std::vector<CefString>& AcceptDescriptions, CefRefPtr<CefFileDialogCallback> Callback)
{
	bool Retval = false;
	TSharedPtr<FOrionCEFWebBrowserWindow> BrowserWindow = BrowserWindowPtr.Pin();
	if (BrowserWindow.IsValid())
...
CefRefPtr<CefCookieAccessFilter> FOrionCEFBrowserHandler::GetCookieAccessFilter(CefRefPtr<CefBrowser> Browser, CefRefPtr<CefFrame> Frame, CefRefPtr<CefRequest> Request)
{
...
bool FOrionCEFBrowserHandler::CanSaveCookie(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame, CefRefPtr<CefRequest> request, CefRefPtr<CefResponse> response, const CefCookie& cookie)
{
	if (bAllowAllCookies)
	{
		return true;
...
bool FOrionCEFBrowserHandler::CanSendCookie(CefRefPtr<CefBrowser> Browser, CefRefPtr<CefFrame> Frame, CefRefPtr<CefRequest> Request, const CefCookie& Cookie)
{
	if (bAllowAllCookies)
	{
		return true;
...
bool FOrionCEFBrowserHandler::URLRequestAllowsCredentials(const FString& URL) const
{
