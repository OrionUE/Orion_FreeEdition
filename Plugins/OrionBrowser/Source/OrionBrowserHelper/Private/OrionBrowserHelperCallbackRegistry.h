...
/** Represents information about a JS function that can be called from the browser process.
	*/
struct FOrionBrowserHelperCallbackRegistryEntry
{
	FOrionBrowserHelperCallbackRegistryEntry(CefRefPtr<CefV8Context> InContext, CefRefPtr<CefV8Value> InObject, CefRefPtr<CefV8Value> InFunction, CefRefPtr<CefV8Value> InOnError, bool bInOneShot)
		: Context(InContext)
		, Object(InObject)
		, Function(InFunction)
		, OnError(InOnError)
...
class FOrionBrowserHelperCallbackRegistry : public TMap<FGuid, FOrionBrowserHelperCallbackRegistryEntry>
{
public:
	/** 
