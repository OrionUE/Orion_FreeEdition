...
#include "OrionBrowserHelperRemoteScripting.h"
#include "OrionBrowserHelper.h"
#include "OrionBrowserHelperRemoteMethodHandler.h"
#if ORION_WITH_CEF3

CefRefPtr<CefV8Value> FOrionBrowserHelperRemoteScripting::CefToV8(CefRefPtr<CefDictionaryValue> Dictionary)
{
...
CefRefPtr<CefV8Value> FOrionBrowserHelperRemoteScripting::CreateUObjectProxy(FGuid ObjectId, CefRefPtr<CefListValue> Methods)
{
	CefRefPtr<CefV8Context> Context = CefV8Context::GetCurrentContext();
	CefRefPtr<CefBrowser> Browser = Context->GetBrowser();
	CefRefPtr<CefV8Value> Result = CefV8Value::CreateObject(nullptr, nullptr);
	CefRefPtr<FOrionBrowserHelperRemoteObject> Remote = new FOrionBrowserHelperRemoteObject(this, Browser, Context, ObjectId);
	for (size_t I=0; I < Methods->GetSize(); ++I)
	{
		CefString MethodName = Methods->GetString(I);
		CefRefPtr<CefV8Value> FunctionProxy = CefV8Value::CreateFunction(MethodName, new FOrionBrowserHelperRemoteMethodHandler(Remote, MethodName));
...
CefRefPtr<CefV8Value> FOrionBrowserHelperRemoteScripting::CefToPlainV8Object(CefRefPtr<CefDictionaryValue> Dictionary)
{
	CefRefPtr<CefV8Value> Result = CefV8Value::CreateObject(nullptr, nullptr);
...
CefRefPtr<CefV8Value> FOrionBrowserHelperRemoteScripting::CefToV8(CefRefPtr<CefListValue> List)
{
...
void FOrionBrowserHelperRemoteScripting::CefToV8Arglist(CefRefPtr<CefListValue> List, CefV8ValueList& Values)
{
	for (size_t i = 0; i < List->GetSize(); ++i)
	{
...
CefRefPtr<CefListValue> FOrionBrowserHelperRemoteScripting::V8ArrayToCef(const CefV8ValueList& Values)
{
...
CefRefPtr<CefListValue> FOrionBrowserHelperRemoteScripting::V8ArrayToCef(CefRefPtr<CefV8Value> Array)
{
	CefRefPtr<CefListValue> Result = CefListValue::Create();
	if (Array->IsArray())
	{
...
CefRefPtr<CefDictionaryValue> FOrionBrowserHelperRemoteScripting::V8ObjectToCef(CefRefPtr<CefV8Value> Object)
{
...
CefRefPtr<CefDictionaryValue> FOrionBrowserHelperRemoteScripting::V8FunctionToCef(CefRefPtr<CefV8Value> Object, CefRefPtr<CefV8Value> Function)
{
	CefRefPtr<CefDictionaryValue> Result = CefDictionaryValue::Create();
...
bool FOrionBrowserHelperRemoteScripting::HandleExecuteJSFunctionMessage(CefRefPtr<CefListValue> MessageArguments)
{
	FGuid Guid;
...
bool FOrionBrowserHelperRemoteScripting::HandleSetValueMessage(CefRefPtr<CefBrowser> Browser, CefRefPtr<CefListValue> MessageArguments)
{
...
bool FOrionBrowserHelperRemoteScripting::HandleDeleteValueMessage(CefRefPtr<CefBrowser> Browser, CefRefPtr<CefListValue> MessageArguments)
{
	CefRefPtr<CefFrame> MainFrame = Browser->GetMainFrame();
	CefRefPtr<CefV8Context> Context = MainFrame->GetV8Context();
	ScopedV8Context ContextScope(Context);
...
bool FOrionBrowserHelperRemoteScripting::OnProcessMessageReceived(CefRefPtr<CefBrowser> Browser,
...
void FOrionBrowserHelperRemoteScripting::OnContextCreated(CefRefPtr<CefBrowser> Browser, CefRefPtr<CefFrame> Frame, CefRefPtr<CefV8Context> Context)
{
	ScopedV8Context ContextScope(Context);
...
void FOrionBrowserHelperRemoteScripting::OnContextReleased(CefRefPtr<CefBrowser> Browser, CefRefPtr<CefFrame> Frame, CefRefPtr<CefV8Context> Context)
{
	for(const TPair<FGuid,CefRefPtr<FOrionBrowserHelperRemoteObject>> &RemoteObject : RemoteObjects)
	{
...
void FOrionBrowserHelperRemoteScripting::InitPermanentBindings(int32 BrowserID, CefRefPtr<CefDictionaryValue> Values)
{
