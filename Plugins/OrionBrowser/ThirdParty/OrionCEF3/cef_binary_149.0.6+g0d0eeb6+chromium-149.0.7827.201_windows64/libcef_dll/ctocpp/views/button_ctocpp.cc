...
//
// $hash=b3ea693c2e44ea0b722fe1fe40aa84eea015d719$
//
...
CefButtonCToCpp::~CefButtonCToCpp() { shutdown_checker::AssertNotShutdown(); }

template <>
cef_button_t *
CefCToCppRefCounted<CefButtonCToCpp, CefButton, cef_button_t>::UnwrapDerived(
    CefWrapperType type, CefButton *c) {
...
template <>
CefWrapperType CefCToCppRefCounted<CefButtonCToCpp, CefButton,
