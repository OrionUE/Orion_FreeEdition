...
CefLayoutCToCpp::~CefLayoutCToCpp() { shutdown_checker::AssertNotShutdown(); }

template <>
cef_layout_t *
CefCToCppRefCounted<CefLayoutCToCpp, CefLayout, cef_layout_t>::UnwrapDerived(
    CefWrapperType type, CefLayout *c) {
...
template <>
CefWrapperType CefCToCppRefCounted<CefLayoutCToCpp, CefLayout,
