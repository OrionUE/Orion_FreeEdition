...
CefRefPtr<
    CefApiVersionTestRefPtrLibrary> CefApiVersionTestRefPtrLibrary::Create() {
...
NO_SANITIZE("cfi-icall")
CefRefPtr<CefApiVersionTestRefPtrLibrary> CefApiVersionTestRefPtrLibrary::
    Create(int value) {
  shutdown_checker::AssertNotShutdown();
  ...
  // Execute
  auto *_retval =
      cef_api_version_test_ref_ptr_library_create_with_default(value);
...
NO_SANITIZE("cfi-icall")
int CefApiVersionTestRefPtrLibraryCToCpp::GetValueLegacy() {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall")
void CefApiVersionTestRefPtrLibraryCToCpp::SetValueLegacy(int value) {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall")
int CefApiVersionTestRefPtrLibraryCToCpp::GetValueExp() {
  shutdown_checker::AssertNotShutdown();
...
#if CEF_API_ADDED(CEF_EXPERIMENTAL)
NO_SANITIZE("cfi-icall")
void CefApiVersionTestRefPtrLibraryCToCpp::SetValueExp(int value) {
  shutdown_checker::AssertNotShutdown();
...
#if CEF_API_REMOVED(13301)
NO_SANITIZE("cfi-icall")
void CefApiVersionTestRefPtrLibraryCToCpp::SetValue(int value) {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall")
int CefApiVersionTestRefPtrLibraryCToCpp::GetValueV1() {
  shutdown_checker::AssertNotShutdown();
...
#if CEF_API_RANGE(13301, 13302)
NO_SANITIZE("cfi-icall")
void CefApiVersionTestRefPtrLibraryCToCpp::SetValueV1(int value) {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall")
int CefApiVersionTestRefPtrLibraryCToCpp::GetValueV2() {
  shutdown_checker::AssertNotShutdown();
...
#if CEF_API_ADDED(13302)
NO_SANITIZE("cfi-icall")
void CefApiVersionTestRefPtrLibraryCToCpp::SetValueV2(int value) {
  shutdown_checker::AssertNotShutdown();
...
CefCToCppRefCounted<CefApiVersionTestRefPtrLibraryCToCpp,
                    CefApiVersionTestRefPtrLibrary,
                    cef_api_version_test_ref_ptr_library_t>::
    UnwrapDerived(CefWrapperType type, CefApiVersionTestRefPtrLibrary *c) {
  if (type == WT_API_VERSION_TEST_REF_PTR_LIBRARY_CHILD) {
    return reinterpret_cast<cef_api_version_test_ref_ptr_library_t *>(
        CefApiVersionTestRefPtrLibraryChildCToCpp_Unwrap(
            reinterpret_cast<CefApiVersionTestRefPtrLibraryChild *>(c)));
  }
#if CEF_API_REMOVED(13301)
...
CefWrapperType CefCToCppRefCounted<
    CefApiVersionTestRefPtrLibraryCToCpp, CefApiVersionTestRefPtrLibrary,
    cef_api_version_test_ref_ptr_library_t>::kWrapperType =
