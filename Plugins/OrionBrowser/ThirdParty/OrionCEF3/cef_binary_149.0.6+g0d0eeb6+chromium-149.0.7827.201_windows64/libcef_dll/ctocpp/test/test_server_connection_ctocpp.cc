...
void CefTestServerConnectionCToCpp::SendHttp200Response(
    const CefString &content_type, const void *data, size_t data_size) {
...
void CefTestServerConnectionCToCpp::SendHttpResponse(
    int response_code, const CefString &content_type, const void *data,
    size_t data_size, const HeaderMap &extra_headers) {
  shutdown_checker::AssertNotShutdown();
...
cef_test_server_connection_t *CefCToCppRefCounted<
    CefTestServerConnectionCToCpp, CefTestServerConnection,
...
template <>
CefWrapperType
    CefCToCppRefCounted<CefTestServerConnectionCToCpp, CefTestServerConnection,
