...
//
// $hash=a9a084b97c9eef0b8da3692b43ffef91c2e65334$
//
...
void CEF_CALLBACK menu_button_delegate_on_window_changed(
    struct _cef_view_delegate_t *self, struct _cef_view_t *view, int added) {
  shutdown_checker::AssertNotShutdown();
...
void CEF_CALLBACK menu_button_delegate_on_layout_changed(
    struct _cef_view_delegate_t *self, struct _cef_view_t *view,
...
void CEF_CALLBACK menu_button_delegate_on_theme_changed(
    struct _cef_view_delegate_t *self, struct _cef_view_t *view) {
  shutdown_checker::AssertNotShutdown();
...
CefRefPtr<CefMenuButtonDelegate> CefCppToCRefCounted<
    CefMenuButtonDelegateCppToC, CefMenuButtonDelegate,
...
template <>
CefWrapperType
    CefCppToCRefCounted<CefMenuButtonDelegateCppToC, CefMenuButtonDelegate,
