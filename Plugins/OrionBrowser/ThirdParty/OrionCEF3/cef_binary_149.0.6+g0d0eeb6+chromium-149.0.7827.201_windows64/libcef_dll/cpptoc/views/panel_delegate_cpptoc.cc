...
//
// $hash=8cb1ad7ff28c03fb8ddd8ac555b4748e40ad66ae$
//
...
cef_size_t CEF_CALLBACK panel_delegate_get_preferred_size(
  ...
  cef_size_t _retval = CefPanelDelegateCppToC::Get(
                           reinterpret_cast<cef_panel_delegate_t *>(self))
...
void CEF_CALLBACK panel_delegate_on_window_changed(
    struct _cef_view_delegate_t *self, struct _cef_view_t *view, int added) {
  shutdown_checker::AssertNotShutdown();
...
void CEF_CALLBACK panel_delegate_on_layout_changed(
    struct _cef_view_delegate_t *self, struct _cef_view_t *view,
...
void CEF_CALLBACK panel_delegate_on_theme_changed(
    struct _cef_view_delegate_t *self, struct _cef_view_t *view) {
  shutdown_checker::AssertNotShutdown();
...
template <>
CefRefPtr<CefPanelDelegate>
CefCppToCRefCounted<CefPanelDelegateCppToC, CefPanelDelegate,
...
template <>
CefWrapperType CefCppToCRefCounted<CefPanelDelegateCppToC, CefPanelDelegate,
