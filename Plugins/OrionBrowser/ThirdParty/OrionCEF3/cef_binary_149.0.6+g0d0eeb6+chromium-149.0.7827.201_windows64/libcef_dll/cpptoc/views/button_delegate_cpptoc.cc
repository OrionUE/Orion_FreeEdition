...
//
// $hash=288b5c61eea52c370075981f511199f778dc8c47$
//
...
void CEF_CALLBACK button_delegate_on_window_changed(
    struct _cef_view_delegate_t *self, struct _cef_view_t *view, int added) {
  shutdown_checker::AssertNotShutdown();
...
void CEF_CALLBACK button_delegate_on_layout_changed(
    struct _cef_view_delegate_t *self, struct _cef_view_t *view,
...
void CEF_CALLBACK button_delegate_on_theme_changed(
    struct _cef_view_delegate_t *self, struct _cef_view_t *view) {
  shutdown_checker::AssertNotShutdown();
...
template <>
CefRefPtr<CefButtonDelegate>
CefCppToCRefCounted<CefButtonDelegateCppToC, CefButtonDelegate,
...
template <>
CefWrapperType CefCppToCRefCounted<CefButtonDelegateCppToC, CefButtonDelegate,
