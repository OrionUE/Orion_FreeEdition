...
#include "CommonInputModifiers.generated.h"
...
/**
 * This is a dead zone input modifier that will have it's thresholds driven by what is in the Shared game settings. 
 */
UCLASS(NotBlueprintable)
class COMMONINPUTSYSTEM_API UCommonInputModifierDeadZone : public UInputModifier
{
	GENERATED_BODY()
