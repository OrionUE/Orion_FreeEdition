...
class FCommonEditorValidationMessageGatherer : public FOutputDevice
{
public:
	FCommonEditorValidationMessageGatherer()
		: FOutputDevice()
	{
		GLog->AddOutputDevice(this);
	}

	virtual ~FCommonEditorValidationMessageGatherer() override
	{
