...
class UGameUIManagerSubsystemBase;
class ULocalPlayer;
...
UCLASS(Abstract, Blueprintable, Within = GameUIManagerSubsystemBase)
...
public:
	...
	UGameUIManagerSubsystemBase* GetOwningUIManager() const;
...
private:
	...
	friend class UGameUIManagerSubsystemBase;
};
