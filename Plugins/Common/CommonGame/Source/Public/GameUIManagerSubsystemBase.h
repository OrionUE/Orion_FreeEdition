...
#include "GameUIManagerSubsystemBase.generated.h"
...
class COMMONGAME_API UGameUIManagerSubsystemBase : public UGameInstanceSubsystem
{
	GENERATED_BODY()
	
public:
	UGameUIManagerSubsystemBase() { }
