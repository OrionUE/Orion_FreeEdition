...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File .agents\skills\ue-framework-skill-authoring\scripts\check-skill-portability.ps1 -Path .agents\skills\<skill-name> -BannedLiteral "<GAME_OR_PROJECT_NAME>" -CheckCRLF -RequireRouting
```
