---
name: orion-editor-extension-framework
...
- 判断代码落点、Editor module 与 Runtime module 边界、Target 选择时，配合 `../orion-framework-architecture/SKILL.md`。
- 编辑器工具创建、保存、编译 Blueprint/UMG/Experience 等资产时，配合 `../orion-mcp-project-toolsets/SKILL.md` 和 `../orion-asset-management/SKILL.md`。
- GameplayCue 编辑器委托、Cue Notify 路径或 GameplayCue 资产规则，配合 `../unreal-gameplayabilities/SKILL.md` 和 `../orion-gamefeatures/SKILL.md`。
- UMG、CommonUI、UIExtension 或 Widget 编辑器工具，配合 `../orion-umg/SKILL.md` 和 `../unreal-commoninput/SKILL.md`。
- 打包、Cook、DataValidation commandlet 或 shipping 构建风险，配合 `../orion-packaging/SKILL.md`。
