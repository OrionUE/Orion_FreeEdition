...
- CommonGame、CommonUser、CommonLoadingScreen、GameplayMessageRuntime；消息收发、tag channel 和委托取舍继续读取 `../unreal-gameplay-message-router/SKILL.md`。
...
| `FCoreVerbMessage` | GameplayMessageRouter 的通用 verb message；新增消息 payload、监听和网络桥接规则继续读取 `../unreal-gameplay-message-router/SKILL.md`。 |
