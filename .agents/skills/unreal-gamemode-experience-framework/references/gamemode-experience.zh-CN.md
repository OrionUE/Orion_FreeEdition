...
玩家账户类、玩家信息组件、玩家 GameplayComponent 和 GameFeature 玩家组件挂载规则读取 `../../unreal-player-framework/SKILL.md`。

角色蓝图基类、PawnData 字段、PawnControl、HeroComponent、PlayerStart/Spawner 和角色生成规则读取 `../../unreal-character-pawn-framework/SKILL.md`。
