...
- 先读取 `.agents/skills/orion-mcp-workflow/SKILL.md`，确认 MCP 连接、保存、弹窗处理和 toolset 调用流程。
- 创建或修改正式资产前，读取 `.agents/skills/orion-asset-management/SKILL.md`，确认正式资产目录、命名前缀和禁止测试目录落点。
